...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='d4.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='d4.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='d4.php';</script>";
    }
}
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="brand-box">
                                <div class="image-box">
                                    <img src="images/resource/deal5.1.jpg">
                                </div>
                                <div class="content-box">
                                    <h3 class="title"> Mumbai Dealer</h3>
                                    ...
                                    <div class="text">Compact, efficient cars for hassle-free city commuting. 
                                        Designed for daily travelers and short-term needs.
                                    </div>
                                    <a href="mumbai.php" class="brand-btn">View All Cars<svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                                                ...
                                                <div class="side-bar">
                                                    ...
                                                    <div class="schedule-sec">
                                                        ...
                                                        <ul class="schedule-list">
                                                            ...
                                                            <li>Monday<span>11:00 - 20:00</span></li>
                                                            <li>Tuesday<span>11:00 - 20:00</span></li>
                                                            <li>Wednesday<span>11:00 - 20:00</span></li>
                                                            <li>Thursday<span>11:00 - 20:00</span></li>
                                                            <li>Friday<span>11:00 - 20:00</span></li>
                            ...
                            <div class="description-sec">
                                ...
                                <div class="text two">MetroEase Rentals is your go-to service for navigating busy city
                                     streets effortlessly. Their fleet of compact and fuel-efficient cars is perfect for
                                      daily commuters, office-goers, and tourists exploring urban areas. Known for their 
                                      competitive rates and quick booking process, they ensure a smooth and convenient experience.
                                    
                                    
                                </div>
                                <div class="text">MetroEase Rentals provides flexible pickup and drop-off points across the city, 
                                    reducing travel time and stress for customers. All vehicles are equipped with modern safety features, 
                                    making them ideal for first-time drivers as well. Popular among students, professionals, and small families,
                                     MetroEase Rentals is redefining city travel with efficiency and affordability.
                                </div>
                            </div>
                            ...
                            <div class="location-box">
                                ...
                                <div class="goole-iframe">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30158.70780388745!2d72.84789087245599!3d19.114740704235576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b61b41dfb131%3A0xa668297563ddac31!2sAndheri%20East%2C%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1739525173568!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                                    </iframe>
                                </div>
                            </div>
                                ...
                                <div class="review-box">
                                    ...
                                    <ul class="review-list two">
                                        ...
                                        <li>
                                            ...
                                            <sub><i class="fa fa-star"></i>4.6</sub>
                                        </li>
                                        <li>
                                            <div class="review-title">
                                            ...
                                            <sub><i class="fa fa-star"></i>4.7</sub>
                                        </li>
                                    </ul>
                                    <ul class="review-list">
                                        <li>
                                            ...
                                            <sub><i class="fa fa-star"></i>4.9</sub>
                                        </li>
                                        <li>
                                            <div class="review-title">
                                            ...
                                            <sub><i class="fa fa-star"></i>4.8</sub>
                                        </li>
                                        <li>
                                            <div class="review-title">

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='d3.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='d3.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='d3.php';</script>";
    }
}
                ...
                <div class="drivons-title-three">
                    <ul class="breadcrumb">
                      <li><a href="dealer.php">Back</a></li>
                        <li><span>Sambhaji Nagar Dealer</span></li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="brand-box">
                                <div class="image-box">
                                    <img src="images/resource/deal4.1.jpg">
                                </div>
                                <div class="content-box">
                                    <h3 class="title">Sambhaji Nagar Dealer</h3>
                                    ...
                                    <div class="text">Environmentally-conscious rentals with electric and hybrid cars.
                                         Suitable for urban and eco-friendly travelers.
                                    </div>
                                    <a href="sambhajinagar.php" class="brand-btn">View All Cars<svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                            ...
                            <div class="description-sec">
                                ...
                                <div class="text two">EcoRide Rentals is dedicated to promoting green mobility through its fleet
                                     of electric and hybrid vehicles. Their cars offer a quiet, smooth driving experience while 
                                     minimizing environmental impact. Ideal for eco-conscious travelers, their rentals are popular 
                                     for both urban commuting and intercity trips. 
                                    
                                    
                                </div>
                                <div class="text">The company provides convenient charging solutions and 24/7 support to ensure a 
                                    seamless experience for renters. EcoRide Rentals also offers affordable pricing plans, making 
                                    eco-friendly travel accessible to everyone. Their mission is to reduce carbon footprints without 
                                    compromising on comfort and convenience. With a growing fleet, they aim to lead the sustainable 
                                    travel revolution.
                                </div>
                            </div>
                            ...
                            <div class="location-box">
                                ...
                                <div class="text">High court hill, Motiwala Complex, Sambhaji Nagar, B60 1BS
                                   <li>Open today 08am - 6pm</li>
                                </div>
                                ...
                                <div class="goole-iframe">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60032.70223393397!2d75.31178710725223!3d19.880368546850562!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdba2dd02059929%3A0x119ff537d5e9095d!2sChilkalthana%2C%20Chhatrapati%20Sambhaji%20Nagar%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1739525110054!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                                    </iframe>
                                </div>
                            </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='d6.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='d6.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='d6.php';</script>";
    }
}
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="brand-box">
                                <div class="image-box">
                                    <img src="images/resource/deal7.1.jpg">
                                </div>
                                <div class="content-box">
                                    <h3 class="title"> Nagpur Dealer</h3>
                                    ...
                                    <div class="text">Executive cars and chauffeur services for corporate travel.
                                         Tailored solutions for business professionals.
                                    </div>
                                    <a href="nagpur.php" class="brand-btn">View All Cars<svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                                                ...
                                                <div class="side-bar">
                                                    ...
                                                    <div class="schedule-sec">
                                                        ...
                                                        <ul class="schedule-list">
                                                            ...
                                                            <li>Monday<span>10:00 - 21:00</span></li>
                                                            <li>Tuesday<span>10:00 - 21:00</span></li>
                                                            <li>Wednesday<span>10:00 - 21:00</span></li>
                                                            <li>Thursday<span>10:00 - 21:00</span></li>
                                                            <li>Friday<span>10:00 - 21:00</span></li>
                                                            <li>Saturday<span>10:00 - 21:00</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="description-sec">
                                ...
                                <div class="text two">BusinessDrive Rentals specializes in providing premium car rental services for corporate clients and 
                                    business professionals. Their fleet includes executive sedans, luxury SUVs, and high-end vehicles designed to impress. 
                                    With a focus on punctuality, professionalism.
                                    
                                    
                                </div>
                                <div class="text"> And customer comfort, BusinessDrive also offers chauffeur-driven options for important meetings and events. 
                                    Ideal for airport transfers, client visits, and conferences, their service ensures a seamless travel experience. Vehicles 
                                    are equipped with modern amenities like Wi-Fi, charging ports, and bottled water to enhance convenience. Their customizable
                                     corporate plans and attentive customer service make BusinessDrive Rentals a trusted partner for business travel.
                                </div>
                            </div>
                            ...
                            </form><div class="Reply-sec" id="sendmsg">

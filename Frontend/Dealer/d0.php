...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='d0.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='d0.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='d0.php';</script>";
    }
}
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="brand-box">
                                <div class="image-box">
                                    <img src="images/resource/deal2.1.jpg">
                                </div>
                                <div class="content-box">
                                    <h3 class="title">Pune Dealer</h3>
                                    ...
                                    <div class="text">Affordable, reliable rentals for urban commuting. Ideal for short-term, budget-friendly travel needs.
                                    </div>
                                    <a href="pune.php" class="brand-btn">View All Cars<svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                                                    ...
                                                    <div class="side-bar">
                                                        ...
                                                        <div class="schedule-sec">
                                                            ...
                                                            <ul class="schedule-list">
                                                                ...
                                                                <li>Monday<span>09:00 - 17:00</span></li>
                                                                <li>Tuesday<span>09:00 - 17:00</span></li>
                                                                <li>Wednesday<span>09:00 - 17:00</span></li>
                                                                <li>Thursday<span>09:00 - 17:00</span></li>
                                                                <li>Friday<span>09:00 - 17:00</span></li>
                            ...
                            <div class="description-sec">
                                ...
                                <div class="text two">City Wheels Rentals is a leading provider of affordable car
                                     rentals for daily commuters and families in urban areas. Their fleet includes 
                                     hatchbacks and sedans that are well-maintained and fuel-efficient, perfect for 
                                     navigating busy city streets.
                                    
                                    
                                </div>
                                <div class="text">They offer flexible rental plans to suit short-term needs, whether 
                                    it's for a few hours or a day. Customers appreciate their transparent pricing, easy
                                     booking process, and responsive customer support. With convenient pickup and drop-off
                                      options, City Wheels ensures hassle-free rentals for all. Popular among college students,
                                       professionals, and families, they have built a reputation for reliability and value for money.
                                </div>
                            </div>
                            ...
                            <div class="location-box">
                                ...
                                <div class="text">Maharaj Road, Hinjawadi, Pune B80 6BS    
                                    <li>Open today 09am - 05pm</li> 
                                </div>
                            ...
                            <form class="row" method="post" action="">
                                ...
                                <div class="col-lg-12">
                                <div class="form-send">
                                    <button type="submit" name="send" class="theme-btn">Send Message<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">

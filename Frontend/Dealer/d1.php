...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='d1.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='d1.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='d1.php';</script>";
    }
}
                ...
                <div class="drivons-title-three">
                    <ul class="breadcrumb">
                      <li><a href="dealer.php">Back</a></li>
                        <li><span>Jalgaon Dealer</span></li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="brand-box">
                                <div class="image-box">
                                    <img src="images/resource/d12.jpg">
                                </div>
                                <div class="content-box">
                                    <h3 class="title">Jalgoan Dealer</h3>
                                    ...
                                    <div class="text">Renowned for excellence in service, Ethan Motors is your
                                         trusted dealership for both new and pre-owned vehicles.
                                    </div>
                                    <a href="jalgaon.php" class="brand-btn">View All Cars<svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                                                ...
                                                <div class="side-bar">
                                                    ...
                                                    <div class="schedule-sec">
                                                        ...
                                                        <ul class="schedule-list">
                                                            ...
                                                            <li>Saturday<span>10:00 - 18:00</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="description-sec">
                                ...
                                <div class="text two">Competitive pricing and unmatched customer care set 
                                    us apart. Trusted dealership offering an extensive range of new 
                                    and pre-owned vehicles.Renowned for competitive pricing and a seamless
                                     buying experience. 
                                    
                                    
                                </div>
                                <div class="text">Customers love our transparency, personalized services, and
                                     flexible financing options..  Our state-of-the-art service center and 
                                     knowledgeable staff ensure your vehicle stays in top condition, providing 
                                     complete peace of mind. We also provide 24/7 roadside assistance, detailed 
                                     vehicle reports, and extended warranties to give you unmatched confidence 
                                     in every purchase.
                                </div>
                            </div>
                                    ...
                                    <div class="service-list">
                                        ...
                                        <div class="list-box">
                                            <ul class="list two">
                                                <li>Luxury Lounge</li>
                                                <li>Free Wi-Fi</li>
                                                <li>Digital Car Configurator</li>
                                                <li>Vehicle Display Zone</li>
                                            </ul>
                                            <ul class="list">
                                                <li>Priority sevice bays</li>
                            ...
                            <div class="location-box">
                                ...
                                <div class="text">Mahatma Gandhi Road, Jilha Peth, MIDC, B40 2BS
                                    Open today 10am - 6pm
                                </div>

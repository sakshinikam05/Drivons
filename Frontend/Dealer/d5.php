...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='d5.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='d5.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='d5.php';</script>";
    }
}
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="brand-box">
                                <div class="image-box">
                                    <img src="images/resource/deal6.1.jpg">
                                </div>
                                <div class="content-box">
                                    <h3 class="title"> Nashik Dealer</h3>
                                    <ul class="contact-list">
                                        ...
                                        <li>
                                            ...
                                            royalrideheritage@gmail.com</li>
                                        <li>
                                    ...
                                    <div class="text">Elegant vintage cars for weddings and special events. 
                                        Ideal for creating a nostalgic travel experience.
                                    </div>
                                    <a href="nashik.php" class="brand-btn">View All Cars<svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                                                ...
                                                <div class="side-bar">
                                                    ...
                                                    <div class="schedule-sec">
                                                        ...
                                                        <ul class="schedule-list">
                                                            ...
                                                            <li>Tuesday<span>09:00 - 19:00</span></li>
                                                            <li>Wednesday<span>09:00 - 19:00</span></li>
                                                            <li>Thursday<span>09:00 - 19:00</span></li>
                                                            <li>Friday<span>09:00 - 19:00</span></li>
                                                            <li>Saturday<span>09:00 - 19:00</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="description-sec">
                                ...
                                <div class="text two">Royal Ride Heritage Rentals specializes in providing classic and vintage cars that evoke
                                     a sense of timeless elegance. Perfect for weddings, anniversaries, and heritage-themed events, their fleet
                                      includes rare and iconic vehicles meticulously restored to their original glory. 
                                    
                                    
                                </div>
                                <div class="text"> Each car is equipped with luxurious interiors and maintained to the highest standards. Chauffeur 
                                    services add a touch of sophistication, ensuring a royal experience for every customer. Their cars have been featured 
                                    in films, photoshoots, and exclusive events, adding charm and authenticity to every occasion. Royal Ride Heritage Rentals 
                                    makes every moment unforgettable with their vintage fleet.
                                </div>
                            </div>

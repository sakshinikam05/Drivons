...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='d2.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='d2.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='d2.php';</script>";
    }
}
        ...
        <div class="barnd-box">
            <div class="drivons-container">
                <div class="drivons-title-three">
                    <ul class="breadcrumb">
                      <li><a href="dealer.html">Back</a></li>
                        <li><span>Navi-Mumbai Dealer</span></li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="brand-box">
                                <div class="image-box">
                                    <img src="images/resource/deal3.1.jpg">
                                </div>
                                <div class="content-box">
                                    <h3 class="title">Navi Mumbai Dealer</h3>
                                    ...
                                    <div class="text">Premium vehicles for elegant travel and special occasions.
                                         Perfect for those who desire comfort and style.
                                    </div>
                                    <a href="naviMumbai.php" class="brand-btn">View All Cars<svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewbox="0 0 15 14" fill="none">
                                    ...
                                    <tr>
                                        <td halign="Right" valign="top" width="80%">
                                            <div style="padding: 10px;">
                                                ...
                                                <div class="side-bar">
                                                    <a href="#sendmsg" class="message">Send Message</a>                                                    <div class="schedule-sec">
                                                        <h6 class="title">Opening hours</h6>
                                                        <ul class="schedule-list">
                                                            <li>Sunday<span>---- Close ----</span></li>
                                                            <li>Monday<span>10:00 - 19:00</span></li>
                                                            <li>Tuesday<span>10:00 - 19:00</span></li>
                                                            <li>Wednesday<span>10:00 - 19:00</span></li>
                                                            <li>Thursday<span>10:00 - 19:00</span></li>
                                                            <li>Friday<span>10:00 - 19:00</span></li>
                                                            <li>Saturday<span>10:00 - 19:00</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="description-sec">
                                ...
                                <div class="text two">Luxury Drive Rentals is synonymous with sophistication and
                                     high-quality service. Their fleet comprises high-end vehicles, including luxury 
                                     sedans, SUVs, and sports cars, designed for customers seeking a premium travel experience. 
                                     Ideal for corporate executives, weddings, anniversaries, and exclusive events.
                                    
                                    
                                </div>
                                <div class="text">Luxury Drive Rentals ensures every journey feels special. 
                                    Their chauffeurs are professionally trained, and their self-drive options 
                                    are perfect for those who prefer privacy. Each car is equipped with advanced 
                                    amenities to enhance comfort and convenience. The company also offers bespoke
                                     services, such as decorative enhancements for weddings and personalized customer support. 
                                     They redefine what it means to travel in style.
                                </div>
                            </div>
                                ...
                                <div class="review-box">
                                    ...
                                    <ul class="review-list two">
                                        <li>
                                            ...
                                            <sub><i class="fa fa-star"></i>4.5</sub>
                                        </li>
                                        <li>
                                            <div class="review-title">
                                    ...
                                    <ul class="review-list">
                                        <li>
                                            ...
                                            <sub><i class="fa fa-star"></i>4.3</sub>
                                        </li>
                                        <li>
                                            <div class="review-title">

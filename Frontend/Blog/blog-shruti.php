...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-shruti.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-shruti.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-shruti.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>How Car Manufacturers Are Adapting to Sustainability</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Shruti Patil</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/cn13.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Sustainability: Building a Greener Future in the Automotive Industry</h4>
                        <div class="text">
                            Car manufacturers are leading the charge toward sustainability by transitioning from traditional combustion engines to electric and hybrid vehicles. Companies like Tesla, Toyota, and BMW are at the forefront, producing a wide range of EVs and hybrids that significantly reduce greenhouse gas emissions. These vehicles rely on renewable energy sources and advanced battery technology, minimizing reliance on fossil fuels. Governments worldwide are incentivizing this shift by implementing stricter emissions standards and offering subsidies for green vehicles, making it financially viable for automakers and consumers. This transition also extends to the development of hydrogen-powered cars and other alternative fuel technologies, which offer even more environmentally friendly options for the future of transportation.
                        </div>
                        <div class="text two">
                            Sustainability efforts go beyond the vehicles themselves, as car manufacturers are rethinking their production processes. Companies are incorporating renewable energy sources, such as solar and wind, into their manufacturing plants to lower their carbon footprint. For example, BMW and Volvo have committed to using recycled materials like aluminum and steel in their vehicles to reduce resource consumption. Additionally, brands are adopting circular economy principles, focusing on recycling vehicle components like batteries, tires, and metals to minimize waste. Innovations in recycling technology allow manufacturers to reclaim valuable materials from old vehicles, further enhancing sustainability efforts. These practices demonstrate a commitment to reducing environmental impact throughout a vehicle’s entire lifecycle, from production to disposal.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Driving Green – Leading the Way to a Sustainable Future!"
                            </div>
                            <span class="name">Shruti Patil</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The role of electric and hybrid vehicles in reducing carbon emissions.</li>
                                    <li><i class="fa-solid fa-check"></i>How alternative fuels, like hydrogen, are shaping sustainable transportation.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of government incentives and regulations on promoting green vehicles.</li>
                                    <li><i class="fa-solid fa-check"></i>How renewable energy sources are integrated into manufacturing processes.</li>
                                    <li><i class="fa-solid fa-check"></i>The use of recycled materials in vehicle production to reduce resource consumption.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The importance of a circular economy in minimizing automotive waste.</li>
                                    <li><i class="fa-solid fa-check"></i>How advanced recycling techniques are reclaiming valuable materials from old vehicles.</li>
                                    <li><i class="fa-solid fa-check"></i>The contribution of sustainable practices to lowering overall industry carbon footprints.</li>
                                    <li><i class="fa-solid fa-check"></i>The technological innovations driving the shift to sustainable manufacturing.</li>
                                    <li><i class="fa-solid fa-check"></i>How car manufacturers are balancing performance, efficiency, and environmental responsibility.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/cn14.jpg" alt=""></figure>
                            </div>
                        </div>

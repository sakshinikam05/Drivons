...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-ajinkya.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-ajinkya.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-ajinkya.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>The Best Car Brands to Watch in 2025</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Ajinkya Salunkhe</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/cn1.jpeg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Innovation: Driving the Future with Smarter, Greener Cars</h4>
                        <div class="text">
                            As the automotive industry continues to evolve, several car brands are standing out in 2025 for their leadership in innovation, sustainability, and cutting-edge technology. Brands like Tesla, with their electric vehicles (EVs), and Rivian, with their focus on electric trucks and SUVs, are at the forefront of the electric revolution. These companies are pushing the envelope with advancements in autonomous driving, AI-assisted systems, and longer battery ranges, making electric vehicles more accessible and practical for consumers. Traditional automakers like BMW, Mercedes-Benz, and Audi are also making strides in the EV market, with plans to transition their entire lineups to electric or hybrid models in the coming years. The commitment to sustainability is a key factor for many of these brands, as they integrate renewable energy sources and environmentally friendly manufacturing processes into their operations. In 2025, consumers can expect to see more electric models, better charging infrastructure, and new features that improve efficiency and performance.
                        </div>
                        <div class="text two">
                            In addition to sustainability, the best car brands in 2025 are investing heavily in the future of mobility, driven by smart technologies and connected experiences. Companies like Ford and General Motors (GM) are prioritizing autonomous driving and enhanced driver assistance systems, making significant strides toward fully autonomous vehicles. Meanwhile, luxury brands like Lexus and Audi are incorporating advanced infotainment systems, augmented reality dashboards, and personalized in-car experiences, creating a new standard of comfort and connectivity for consumers. These companies are also embracing the concept of shared mobility, offering subscription services and on-demand car-sharing platforms, which is reshaping how people access and use cars. As the demand for innovative, smart, and eco-friendly transportation solutions increases, the leading brands are focusing on integrated, tech-driven experiences that enhance both performance and convenience for drivers. The future of cars in 2025 will be defined not just by their powertrains, but by the technologies they incorporate to make driving safer, smarter, and more sustainable.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Drive the Future – Smart, Sustainable, and Connected!"
                            </div>
                            <span class="name">Ajinkya Salunkhe</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The top car brands leading the way in electric vehicle production.</li>
                                    <li><i class="fa-solid fa-check"></i>How traditional car manufacturers are transitioning to electric and hybrid models.</li>
                                    <li><i class="fa-solid fa-check"></i>The advancements in battery technology and electric vehicle ranges.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of sustainability in shaping the future of the automotive industry.</li>
                                    <li><i class="fa-solid fa-check"></i>How autonomous driving technology is transforming the way we travel.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The growing importance of smart technology in creating connected driving experiences.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of augmented reality and AI in the car infotainment and safety systems.</li>
                                    <li><i class="fa-solid fa-check"></i>The shift toward shared mobility solutions and car subscription services.</li>
                                    <li><i class="fa-solid fa-check"></i>The key innovations in driver assistance systems and autonomous vehicles.</li>
                                    <li><i class="fa-solid fa-check"></i>How luxury car brands are integrating comfort and high-tech features for consumers.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/cn27.png" alt=""></figure>
                            </div>
                        </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-atharva.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-atharva.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-atharva.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>Protecting Your Car’s Paint with Ceramic Coatings</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Atharva Sonar</a></li>
                    <li><a href="#" title="">News</a></li>
                    <li>January 07, 2023</li>
                </ul>
            </div>
        </div>
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/coatt.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Durability: Strengthening Your Car's Paint with Ceramic Coatings</h4>
                        <div class="text">
                            Ceramic coatings provide a revolutionary level of protection for your car’s paint by creating a hydrophobic layer that repels water, dirt, and contaminants. This advanced technology bonds to the paint’s surface, providing a durable, long-lasting shield that helps prevent oxidation, water spots, and UV damage. Unlike traditional waxes, which wear off after a few washes, ceramic coatings last much longer—often up to two to five years—offering consistent protection without frequent reapplication. This layer not only makes your car easier to clean but also enhances its shine, giving it a sleek, glossy finish that lasts longer than conventional products.
                        </div>
                        <div class="text two">
                            One of the biggest benefits of ceramic coatings is the enhanced durability it provides to your vehicle’s paint. The coating acts as a strong barrier against environmental contaminants like bird droppings, tree sap, and road salts, which can cause long-term damage to the paint. It also adds an extra layer of scratch resistance, protecting against minor abrasions from daily wear. Furthermore, ceramic coatings reduce the need for frequent washing, as they keep dirt from sticking to the surface, making your car easier to maintain. By investing in a ceramic coating, you’re not only preserving the aesthetic appearance of your car but also its overall value.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Unmatched Shine, Unbeatable Protection – Shield Your Car with Ceramic Coatings!"
                            </div>
                            <span class="name">Atharva Sonar</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How ceramic coatings create a hydrophobic, water-repelling surface.</li>
                                    <li><i class="fa-solid fa-check"></i>The long-lasting benefits of using ceramic coatings versus traditional wax.</li>
                                    <li><i class="fa-solid fa-check"></i>How ceramic coatings prevent oxidation and UV damage.</li>
                                    <li><i class="fa-solid fa-check"></i>The enhanced scratch resistance provided by ceramic coatings.</li>
                                    <li><i class="fa-solid fa-check"></i>How ceramic coatings protect against environmental contaminants.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The difference between a ceramic coating and regular paint protection.</li>
                                    <li><i class="fa-solid fa-check"></i>The ease of maintaining a ceramic-coated vehicle.</li>
                                    <li><i class="fa-solid fa-check"></i>The financial benefits of investing in ceramic coatings for long-term paint protection.</li>
                                    <li><i class="fa-solid fa-check"></i>How ceramic coatings enhance the shine and gloss of your vehicle.</li>
                                    <li><i class="fa-solid fa-check"></i>The process of applying a ceramic coating and how it bonds to your car’s paint.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/coattt.jpg" alt=""></figure>
                            </div>
                        </div>

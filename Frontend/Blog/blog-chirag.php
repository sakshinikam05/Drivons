...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-chirag.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-chirag.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-chirag.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>How To Save On Car Fuel Costs</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Chirag Jain</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/fuell.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Efficiency: Maximizing Fuel Use Without Compromise</h4>
                        <div class="text">
                            One of the most effective ways to save on fuel costs is by adopting more efficient driving habits. Avoid aggressive driving, such as rapid acceleration and harsh braking, as this can significantly reduce fuel efficiency. Instead, aim for smooth, gradual acceleration and deceleration, which allows the car to operate in the most fuel-efficient range. Additionally, maintaining a steady speed and using cruise control on highways can prevent unnecessary fuel consumption. Avoid idling for long periods, as modern engines use more fuel when idling than when driving at lower speeds. Keeping your driving habits smooth and consistent is key to saving fuel and money over time.
                        </div>
                        <div class="text two">
                            Keeping your vehicle in top condition can help improve fuel efficiency and lower overall fuel costs. Regular maintenance, such as changing the oil, replacing air filters, and keeping the engine tuned, ensures that your vehicle runs at its best. One of the most impactful factors is tire pressure; under-inflated tires cause more rolling resistance, which can decrease fuel efficiency by up to 3%. Make it a habit to check tire pressure regularly and inflate them to the manufacturer-recommended levels. Additionally, reducing the weight in your car, such as removing unnecessary items from the trunk, and using the correct motor oil grade can contribute to better fuel economy. Ensuring your car is well-maintained reduces fuel wastage and prolongs the vehicle’s lifespan.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Drive Smart, Save Big – Maximize Efficiency, Minimize Fuel Costs!"
                            </div>
                            <span class="name">Chirag Jain</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How smooth driving can reduce fuel consumption.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of tire pressure on fuel efficiency.</li>
                                    <li><i class="fa-solid fa-check"></i>How maintaining a steady speed saves fuel.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of engine maintenance in fuel economy.</li>
                                    <li><i class="fa-solid fa-check"></i>The benefits of reducing excess weight in your vehicle.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How using cruise control on highways can save fuel.</li>
                                    <li><i class="fa-solid fa-check"></i>Why idling for extended periods wastes fuel.</li>
                                    <li><i class="fa-solid fa-check"></i>The importance of using the correct motor oil for your car.</li>
                                    <li><i class="fa-solid fa-check"></i>How regular oil changes can enhance fuel efficiency.</li>
                                    <li><i class="fa-solid fa-check"></i>The financial benefits of better fuel management and maintenance.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/fuelll.jpg" alt=""></figure>
                            </div>
                        </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-sakshi.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-sakshi.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-sakshi.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>Why Regular Auto Detailing is Important</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Sakshi Nikam</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/auto.2.png" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Protection: Ensuring Long-Term Durability and Value</h4>
                        <div class="text">
                            Regular auto detailing ensures your vehicle maintains its aesthetic appeal and extends its lifespan. When you clean and protect your car’s exterior and interior, you’re reducing the long-term effects of wear and tear. Regular detailing helps preserve the car’s paintwork by removing contaminants that can lead to oxidation or rust. Additionally, the interior cleaning protects upholstery and dashboard components from sun damage, dirt, and grime, maintaining your vehicle’s resale value. A well-maintained car is more appealing to potential buyers, and you’ll get a better price when it’s time to sell or trade.
                        </div>
                        <div class="text two">
                            The interior of your vehicle can accumulate dust, allergens, and bacteria, which could negatively impact your health, especially if you or your passengers suffer from allergies or respiratory issues. Regular detailing cleans all the hard-to-reach places like vents, seat crevices, and carpets, ensuring a hygienic environment. This also enhances the comfort of your driving experience, as a clean, fresh-smelling car is far more pleasant to spend time in, whether on daily commutes or long road trips. Regular detailing not only protects the vehicle but also provides a healthier environment for you and your family.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Shine Beyond the Surface, Drive with Confidence – Regular Detailing, Lasting Protection!"
                            </div>
                            <span class="name">Sakshi Nikam</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How to maintain the car’s exterior and interior.</li>
                                    <li><i class="fa-solid fa-check"></i>The best techniques for deep cleaning surfaces and fabrics.</li>
                                    <li><i class="fa-solid fa-check"></i>The importance of preserving a vehicle’s resale value.</li>
                                    <li><i class="fa-solid fa-check"></i>Methods for protecting paint from environmental damage.</li>
                                ...
                                <ul class="list">
                                    ...
                                    <li><i class="fa-solid fa-check"></i>The difference between standard cleaning and professional detailing.</li>
                                    <li><i class="fa-solid fa-check"></i>How detailing improves the car’s overall hygiene and air quality.</li>
                                    <li><i class="fa-solid fa-check"></i>Techniques for preventing buildup of dirt, grime, and allergens.</li>
                                    <li><i class="fa-solid fa-check"></i>The financial benefits of regular detailing in maintaining your car's value.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="https://autocarrepair.in/resources/views/front/detailing/img/carousel-bg-1.jpg" alt=""></figure>
                            </div>
                        </div>

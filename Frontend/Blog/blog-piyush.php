...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-piyush.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-piyush.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-piyush.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>Top New Car Models Launching in 2025</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Piyush Patil</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/cn3.avif" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Innovation: Driving into a Smart, Safe, and Sustainable Future</h4>
                        <div class="text">
                            The year 2025 is expected to bring a wave of innovative electric vehicle (EV) models to the market, catering to the increasing demand for eco-friendly transportation. Many leading automotive brands are unveiling EVs with enhanced battery range, faster charging capabilities, and cutting-edge technology. These new models will not only offer sustainability but also superior performance, advanced safety features, and luxurious interiors. Automakers are focusing on reducing the carbon footprint while integrating autonomous driving capabilities, AI-assisted technology, and improved infotainment systems to provide a seamless driving experience. Consumers can expect more affordable electric options as well, making EVs more accessible to a broader audience. Along with traditional sedans and SUVs, some automakers are launching electric pickup trucks, expanding the range of eco-friendly vehicles in different categories.
                        </div>
                        <div class="text two">
                            In 2025, car models will increasingly feature enhanced safety features, including autonomous driving technologies and advanced driver assistance systems (ADAS). These innovations are designed to reduce accidents and improve overall driving experiences. Expect new vehicles with 360-degree cameras, adaptive cruise control, automatic emergency braking, and lane-keeping assist. Alongside safety, there will be a significant focus on tech integration, with many models incorporating smart connectivity, voice-activated controls, and customizable digital dashboards. The integration of augmented reality (AR) will allow for navigation and real-time data to be displayed directly on the windshield. In addition to safety and technology, manufacturers are introducing vehicles with more spacious, luxurious interiors, offering a more comfortable and connected ride. With these advancements, the 2025 car models promise to raise the bar for convenience, comfort, and safety.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Drive into the Future – Cutting-Edge Cars for Tomorrow’s Roads!"
                            </div>
                            <span class="name">Piyush Patil</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How electric vehicles are becoming more affordable and accessible.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of advanced battery technology in expanding the range of electric vehicles./li>
                                    <li><i class="fa-solid fa-check"></i>The importance of sustainability in the automotive industry.</li>
                                    <li><i class="fa-solid fa-check"></i>How autonomous driving and AI technologies are enhancing vehicle safety.</li>
                                    <li><i class="fa-solid fa-check"></i>The integration of advanced driver assistance systems (ADAS) in new models.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The impact of augmented reality on navigation and in-car displays.</li>
                                    <li><i class="fa-solid fa-check"></i>How automakers are improving vehicle interiors for greater comfort and luxury.</li>
                                    <li><i class="fa-solid fa-check"></i>The significance of smart connectivity and voice-activated controls in modern cars.</li>
                                    <li><i class="fa-solid fa-check"></i>The introduction of electric pickup trucks and other eco-friendly vehicles.</li>
                                    <li><i class="fa-solid fa-check"></i>How the automotive industry is evolving with more tech-driven, connected cars.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/cn4.jpg" alt=""></figure>
                            </div>
                        </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-nandini.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-nandini.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-nandini.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>How Often Should You Detail Your Car?</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Nandini Patil</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/detaill.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Preservation: Keeping Your Car in Top Condition Year-Round</h4>
                        <div class="text">
                            How often you should detail your car largely depends on the environmental conditions your vehicle is exposed to. If you live in an area with harsh weather, such as frequent rain, snow, or high UV exposure, it’s important to detail your car more often to protect the paint and keep the exterior in good condition. For instance, vehicles exposed to salty roads in winter may require detailing every 3 to 4 months to prevent rust and salt buildup. In hot, sunny climates, the paint can fade faster due to UV rays, so regular waxing and paint protection are essential. On the other hand, if you live in a mild climate with fewer contaminants, you may only need to detail your car every 6 months. Regular maintenance, including washing and waxing, can help protect the car between professional detailing appointments.
                        <div class="text two">
                            In addition to environmental factors, how often you detail your car can depend on your personal preferences and how much you use the vehicle. If you want to keep your car looking as close to new as possible, frequent detailing will ensure it maintains its pristine condition. For high-end or luxury vehicles, more frequent detailing can help preserve the car’s value and appearance. For everyday drivers, detailing every 4 to 6 months may be enough, but it’s crucial to keep the car clean in between with regular washes to prevent dirt buildup. Also, if you regularly transport pets or children, or your car accumulates dirt and debris quickly, more frequent cleaning and detailing may be needed to maintain a clean and fresh environment.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Keep It Clean, Keep It Pristine – Detail Your Car, Preserve Its Shine!"
                            </div>
                            <span class="name">Nandini Patil</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How environmental conditions affect how often you should detail your car.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of weather elements like rain, snow, and UV rays on your vehicle.</li>
                                    <li><i class="fa-solid fa-check"></i>Why waxing and paint protection are important for maintaining your car’s exterior.</li>
                                    <li><i class="fa-solid fa-check"></i>How often high-end or luxury cars should be detailed to retain their value.</li>
                                    <li><i class="fa-solid fa-check"></i>The difference between regular washing and professional detailing.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How frequent detailing can prevent long-term damage to your car.</li>
                                    <li><i class="fa-solid fa-check"></i>The importance of interior detailing for maintaining a clean and comfortable space.</li>
                                    <li><i class="fa-solid fa-check"></i>Why regular detailing enhances your car’s aesthetic appeal and market value.</li>
                                    <li><i class="fa-solid fa-check"></i>How much vehicle usage can influence the frequency of detailing.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of detailing in preserving the vehicle’s lifespan and appearance.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/detailll.jpg" alt=""></figure>
                            </div>
                        </div>

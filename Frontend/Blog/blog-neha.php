...
if (isset($_POST['send'])) {
    ...
    try {
        ...
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='your_page.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>Exterior Detailing: How to Clean Wheels and Tires</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Neha Patil</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/extt.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Shine: Achieving Clean and Glossy Wheels and Tires</h4>
                        <div class="text">
                            Cleaning your car’s wheels and tires is a crucial part of exterior detailing. Start by thoroughly rinsing the wheels and tires with water to remove loose dirt, brake dust, and grime. Using a pressure washer or hose with a strong water flow is effective in loosening up dirt from the wheel wells and tire treads. After rinsing, apply a specialized wheel cleaner to break down the buildup of brake dust and grease. Be sure to choose a wheel cleaner that matches the type of wheel you have (e.g., aluminum, chrome, or painted). Let the cleaner sit for a few minutes to loosen the contaminants, but avoid letting it dry on the surface, as this could lead to staining or damage.
                      </div>
                        <div class="text two">
                            Once the wheel cleaner has had time to sit, use a soft-bristle brush or wheel brush to scrub the wheels thoroughly, paying special attention to the lug nut areas and the inner parts of the wheel where grime tends to accumulate. Use a separate brush for the tires to remove any embedded dirt and oils. For stubborn spots, a clay bar can be used to gently remove contaminants from the wheel surface. After scrubbing, rinse everything off thoroughly to ensure no cleaner or debris is left behind. Once the wheels are clean and dry, apply a tire dressing or protectant to the tires to enhance their appearance and offer protection from cracking, fading, and UV damage. 
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Shine and Protect – Clean Wheels, Perfect Ride!"
                            </div>
                            <span class="name">Neha Patil</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The importance of rinsing wheels and tires.</li>
                                    <li><i class="fa-solid fa-check"></i>How to choose the right wheel cleaner.</li>
                                    <li><i class="fa-solid fa-check"></i>The best methods for scrubbing and cleaning wheels.</li>
                                    <li><i class="fa-solid fa-check"></i>Why using a separate brush for tires.</li>
                                    <li><i class="fa-solid fa-check"></i>How to remove brake dust.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The benefits of using a clay bar.</li>
                                    <li><i class="fa-solid fa-check"></i>How to properly apply and remove tire.</li>
                                    <li><i class="fa-solid fa-check"></i>The importance of regular cleaning.</li>
                                    <li><i class="fa-solid fa-check"></i>How to protect your tires from cracking.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of wheel protectants in preserving .</li>
                                </ul>
                            </div>
                        </div> 
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/exttt.jpg" alt=""></figure>
                            </div>
                        </div>

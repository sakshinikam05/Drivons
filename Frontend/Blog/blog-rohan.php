...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-rohan.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-rohan.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-rohan.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>How Autonomous Vehicles Will Change the Car Industry</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Rohan Nanda</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/cn8.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Innovation: Shaping a Smarter, Safer, and More Inclusive Future of Transportation</h4>
                        <div class="text">
                            Autonomous vehicles (AVs) are set to dramatically reshape the car industry by revolutionizing the driving experience. These self-driving cars rely on advanced sensors, machine learning algorithms, and artificial intelligence to navigate the roads, removing the need for human intervention. The impact will be profound in terms of convenience, as passengers will no longer have to focus on driving, allowing them to use travel time more productively. Autonomous vehicles promise to reduce human error, which is responsible for a significant portion of road accidents. As AV technology improves, the driving experience will become more seamless, with the vehicle autonomously adjusting speed, lane position, and even route planning. This transformation is expected to change not just the way we drive, but the very concept of car ownership, with many consumers opting for autonomous ride-sharing services rather than owning a personal vehicle
                        </div>
                        <div class="text two">
                            Beyond individual driving experiences, autonomous vehicles will lead to a major shift in the automotive business and transportation infrastructure. Car manufacturers are investing heavily in AV technology, which will impact their design and production processes. As autonomous technology becomes mainstream, there will be an increased demand for software development, cybersecurity, and AI innovation, creating new opportunities within the tech and automotive industries. Infrastructure will also need to evolve, with cities redesigning roads, traffic systems, and parking areas to accommodate self-driving vehicles. Autonomous cars will lead to the rise of smart cities, where transportation is more integrated, efficient, and sustainable. Moreover, AVs will provide greater mobility to those who are unable to drive, such as the elderly and disabled, fostering inclusivity in transportation.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Drive Without Hands – The Future of Travel is Autonomous!"
                            </div>
                            <span class="name">Rohan Nanda</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How autonomous vehicles are redefining the driving experience and car ownership.</li>
                                    <li><i class="fa-solid fa-check"></i>The technology behind self-driving cars, including AI, machine learning, and sensors.</li>
                                    <li><i class="fa-solid fa-check"></i>How autonomous cars can significantly reduce road accidents caused by human error.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of autonomous vehicles in creating new business models like ride-sharing.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of autonomous vehicles on traditional car manufacturers and suppliers.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How autonomous vehicles will integrate into smart city infrastructure.</li>
                                    <li><i class="fa-solid fa-check"></i>The potential for autonomous cars to increase mobility for people with disabilities.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of cybersecurity and software development in supporting autonomous vehicle systems.</li>
                                    <li><i class="fa-solid fa-check"></i>How the mass adoption of autonomous cars will impact traffic patterns and road safety.</li>
                                    <li><i class="fa-solid fa-check"></i>The ethical and regulatory challenges surrounding autonomous vehicles.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/cn7.jpg" alt=""></figure>
                            </div>
                        </div>

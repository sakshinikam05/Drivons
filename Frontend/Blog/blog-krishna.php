...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-krishna.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-krishna.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-krishna.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>Top Car Detailing Mistakes to Avoid</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Krishna Jala</a></li>
            ...
            <div class="large-container">
                <div class="content-box">
                    ...
                    <div class="right-box-two">
                        <h4 class="title">Protection: Avoiding Damage Through Proper Detailing Techniques</h4>
                        <div class="text">
                            One of the biggest mistakes in car detailing is using the wrong cleaning products and tools, which can damage your car’s surfaces rather than clean them. For example, using household cleaning products like dish soap or harsh chemicals can strip away protective wax coatings and damage your paint. Similarly, using the wrong type of cloth, such as abrasive towels or old rags, can cause swirl marks and scratches on the surface. Always choose car-specific cleaning products like pH-balanced shampoos and microfiber towels designed to be gentle on the paint. It’s crucial to invest in high-quality tools, such as soft brushes and microfiber cloths, to prevent damaging your vehicle while achieving the best results.
                        <div class="text two">
                            Another common mistake is neglecting regular maintenance or over-polishing the car. While polishing can enhance the car’s shine, doing it too often can wear down the clear coat over time, leading to dullness and increased vulnerability to scratches. It’s essential to understand that regular cleaning and the application of protective layers such as wax or ceramic coatings are enough to keep the car in top shape. Over-polishing should be avoided unless necessary, as it can remove layers of paint, diminishing the car’s protection. Similarly, neglecting to clean and maintain the interior can result in stained upholstery, foul odors, and the buildup of dirt and dust in hard-to-reach places.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Detail with Care, Avoid the Wear – Master the Art of Car Care!"
                            </div>
                            <span class="name">Krishna Jala</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The importance of using the correct cleaning products for your car.</li>
                                    <li><i class="fa-solid fa-check"></i>Why harsh chemicals should be avoided when detailing your car.</li>
                                    <li><i class="fa-solid fa-check"></i>The benefits of using microfiber towels and soft brushes.</li>
                                    <li><i class="fa-solid fa-check"></i>How over-polishing can damage the paint and clear coat.</li>
                                    <li><i class="fa-solid fa-check"></i>The significance of regular, rather than excessive, polishing.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How to maintain the interior to prevent dirt buildup and stains.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of waxing and ceramic coatings in protecting your vehicle.</li>
                                    <li><i class="fa-solid fa-check"></i>How using improper tools can lead to scratches and swirl marks.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of using the wrong cleaning solutions on your car’s finish.</li>
                                    <li><i class="fa-solid fa-check"></i>Why routine maintenance is essential to maintaining your car’s appearance and value.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/painttt.jpg" alt=""></figure>
                            </div>
                        </div>

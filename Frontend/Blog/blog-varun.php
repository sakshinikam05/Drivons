...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-varun.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-varun.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-varun.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>The Rise of Hybrid Cars in 2025</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Varun Sood</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/CN17.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Efficiency: The Future of Transportation with Hybrid Power</h4>
                        <div class="text">
                            As fuel prices continue to rise and environmental concerns grow, hybrid cars are gaining significant popularity in 2025. These vehicles combine the benefits of traditional gasoline engines with electric power, offering superior fuel efficiency without compromising performance. The rise of hybrid cars comes as automakers respond to consumer demand for more sustainable transportation options that reduce emissions and fuel consumption. With advances in hybrid technology, these vehicles are offering longer electric-only driving ranges, making them more practical for daily commutes. As hybrid cars become more affordable and accessible, they offer a middle ground between fully electric vehicles and gasoline-powered cars, providing the best of both worlds: environmental sustainability and convenience. The ability to reduce reliance on fossil fuels while maintaining range and performance is driving the adoption of hybrid vehicles worldwide.
                        </div>
                        <div class="text two">
                            In 2025, hybrid cars are benefiting from major technological advancements that improve performance and efficiency. New hybrid systems are more sophisticated, offering smoother transitions between the gasoline engine and electric motor. Many hybrids now come equipped with regenerative braking systems, which help recharge the battery while slowing the car down, further improving fuel economy. Additionally, the development of lighter materials and more efficient batteries has made hybrid cars more efficient and affordable than ever before. With tax incentives and rebates offered in many countries, hybrid vehicles are also becoming a cost-effective option for environmentally-conscious consumers. The rise of hybrid cars is also prompting the development of charging infrastructure and more sustainable battery technologies, which will further boost the adoption of these vehicles as a key solution to addressing climate change and reducing the carbon footprint of transportation.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Fuel the Future – Hybrid Power for a Sustainable Tomorrow!"
                            </div>
                            <span class="name">Varun Sood/span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The environmental benefits of hybrid cars and their role in reducing emissions.</li>
                                    <li><i class="fa-solid fa-check"></i>How hybrid technology combines electric motors and gasoline engines for superior fuel efficiency.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of rising fuel prices on the growing demand for hybrid vehicles.</li>
                                    <li><i class="fa-solid fa-check"></i>The technological advancements that make hybrid cars more efficient and practical.</li>
                                    <li><i class="fa-solid fa-check"></i>How regenerative braking systems help improve fuel economy in hybrid vehicles.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The role of hybrid cars in reducing reliance on fossil fuels.</li>
                                    <li><i class="fa-solid fa-check"></i>The affordability of hybrid vehicles and the impact of government incentives.</li>
                                    <li><i class="fa-solid fa-check"></i>How lighter materials and more efficient batteries contribute to hybrid performance.</li>
                                    <li><i class="fa-solid fa-check"></i>The potential of hybrid cars to bridge the gap between traditional vehicles and fully electric cars.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of charging infrastructure and battery technology in the growth of hybrid vehicles.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/CN18.png" alt=""></figure>
                            </div>
                        </div>

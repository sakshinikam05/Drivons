...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-priti.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-priti.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-priti.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>Car Industry’s Response to Rising Fuel Prices</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Priti Gupta</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/cn.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Innovation: Adapting to Fuel Prices with Smarter, Greener Vehicles</h4>
                        <div class="text">
                            As fuel prices continue to rise globally, the car industry is increasingly focused on producing fuel-efficient and hybrid vehicles. Consumers are seeking alternatives to traditional gasoline-powered cars, which have become more expensive to operate due to higher fuel costs. In response, automakers are accelerating the development of hybrid and plug-in hybrid models, which combine the power of gasoline engines with electric motors. These vehicles offer improved fuel economy and can help consumers save money on fuel over time. Additionally, some car manufacturers are focusing on smaller, more efficient engines that maintain performance while consuming less fuel. With governments offering tax incentives and rebates for fuel-efficient vehicles, the demand for hybrids and electric vehicles (EVs) is expected to grow, further driving the car industry's response to rising fuel prices.
                            </div>
                        <div class="text two">
                            In addition to hybrid models, the car industry is investing heavily in electric vehicles (EVs) and alternative fuel technologies. EVs, which rely solely on electric power, eliminate the need for gasoline altogether, offering significant cost savings for consumers in terms of fuel. The growing popularity of EVs is supported by advancements in battery technology, longer ranges, and faster charging times. Furthermore, many automakers are exploring alternative fuels, such as hydrogen fuel cells and compressed natural gas, which can reduce dependence on traditional gasoline and diesel. With the continued development of charging infrastructure and government incentives for clean energy vehicles, electric cars and alternative fuel vehicles are becoming more mainstream. This shift not only addresses rising fuel prices but also contributes to reducing the automotive industry's carbon footprint, making it a critical part of the global effort to fight climate change.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Drive Smart – Fuel Efficiency for a Greener Future!"
                            </div>
                            <span class="name">Priti Gupta</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How the rise in fuel prices is driving demand for fuel-efficient vehicles./li>
                                    <li><i class="fa-solid fa-check"></i>The role of hybrid cars in improving fuel economy and reducing operating costs.</li>
                                    <li><i class="fa-solid fa-check"></i>The technological advancements in electric vehicles (EVs) and how they reduce fuel dependency.</li>
                                    <li><i class="fa-solid fa-check"></i>How smaller and more efficient engines help maintain performance while reducing fuel consumption.</li>
                                    <li><i class="fa-solid fa-check"></i>The impact of government incentives and rebates in promoting fuel-efficient vehicles.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The shift in consumer preferences towards hybrids and EVs in response to fuel costs.</li>
                                    <li><i class="fa-solid fa-check"></i>The development of alternative fuel technologies, such as hydrogen and compressed natural gas.</li>
                                    <li><i class="fa-solid fa-check"></i>How the automotive industry is contributing to reducing global carbon emissions.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of infrastructure, such as charging stations, in making EVs more accessible to consumers.</li>
                                    <li><i class="fa-solid fa-check"></i>The long-term financial and environmental benefits of adopting fuel-efficient and electric vehicles.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/cn2.jpg" alt=""></figure>
                            </div>
                        </div>

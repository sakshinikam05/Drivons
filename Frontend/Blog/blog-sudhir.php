...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='blog-shudhir.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='blog-shudhir.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='blog-shudhir.php';</script>";
    }
}
    ...
    <section class="blog-section-five layout-radius">
        <div class="drivons-container">
            <div class="drivons-title wow fadeInUp">
                ...
                <h2>Electric Cars: The Future of Transportation</h2>
                <ul class="post-info">
                    <li><img src="images/resource/pfp.jpg"></li>
                    <li><a href="#" title="">Sudhir Patni</a></li>
        ...
        <div class="right-box">
            <div class="large-container">
                <div class="content-box">
                    <figure class="outer-image"><img src="images/resource/cn15.jpg" alt=""></figure>
                    <div class="right-box-two">
                        <h4 class="title">Innovation: Shaping the Future with Electric Cars</h4>
                        <div class="text">
                            Electric cars are at the forefront of revolutionizing transportation, offering significant environmental benefits over traditional gasoline-powered vehicles. One of the most notable advantages is their ability to reduce carbon emissions, which contributes to cleaner air and a reduction in greenhouse gases. Since electric cars don’t rely on fossil fuels for energy, they help lower the demand for oil and contribute to the global effort to reduce climate change. In addition, electric vehicles (EVs) produce zero tailpipe emissions, which is a major step in improving urban air quality, especially in densely populated areas where pollution is a significant issue. As the world continues to shift toward renewable energy sources, the environmental benefits of electric cars will only continue to grow.
                        </div>
                        <div class="text two">
                            Electric cars are not only better for the environment but also for the wallet in the long term. Thanks to advancements in battery technology, EVs now offer improved performance, longer ranges, and faster charging times, making them increasingly convenient for daily use. The cost of electric cars is also decreasing as production scales up and battery technology improves, bringing EVs into reach for more consumers. Moreover, owning an electric car can result in significant savings on fuel and maintenance. EVs have fewer moving parts than internal combustion engine vehicles, meaning there’s less wear and tear, leading to lower maintenance costs. Additionally, electricity is cheaper than gasoline, which means that EV owners spend significantly less on fuel over the life of the car.
                        </div>
                        <div class="auther-box">
                            <div class="text">
                                "Drive the Future – Clean, Efficient, Electric!"
                            </div>
                            <span class="name">Sudhir Patni</span>
                        </div>
                        <div class="list-sec">
                            <h6 class="title">What you'll learn</h6>
                            <div class="inner-column">
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>The environmental impact of electric cars and their role in reducing emissions.</li>
                                    <li><i class="fa-solid fa-check"></i>How electric vehicles contribute to cleaner air and reduced urban pollution.</li>
                                    <li><i class="fa-solid fa-check"></i>The importance of preserving a vehicle’s resale value.</li>
                                    <li><i class="fa-solid fa-check"></i>The difference in emissions between electric and gasoline-powered vehicles.</li>
                                    <li><i class="fa-solid fa-check"></i>Understanding the impact of regular cleaning on vehicle longevity.</li>
                                </ul>
                                <ul class="list">
                                    <li><i class="fa-solid fa-check"></i>How to restore and maintain the car’s aesthetic appeal.</li>
                                    <li><i class="fa-solid fa-check"></i>The potential for electric vehicles to reduce dependency on fossil fuels.</li>
                                    <li><i class="fa-solid fa-check"></i>The role of electric cars in the global effort to combat climate change.</li>
                                    <li><i class="fa-solid fa-check"></i>Techniques for preventing buildup of dirt, grime, and allergens.</li>
                                    <li><i class="fa-solid fa-check"></i>The long-term financial and environmental benefits of transitioning to electric vehicles.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="image-sec">
                            <div class="image-box">
                                <figure class="inner-image"><img src="images/resource/cn16.jpg" alt=""></figure>
                            </div>
                        </div>

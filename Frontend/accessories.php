...
// Check if the session exists and is set to true
if (!isset($_SESSION['car_selected']) || $_SESSION['car_selected'] !== true) {
    echo "<script>alert('Please Book A Car First!'); window.location.href='inventory.php';</script>";
    exit();
} 

// Ensure the session is cleared if no car is selected
...
<head>
<meta charset="utf-8">
<title>Drivons | Accessories</title>
<!-- Stylesheets -->
                    ...
                    <div class="categories-box">
                        ...
                        <div class="radio">
                            <label class="contain">Accessories (6)
                                <input type="radio" name="categories-box" value="accessories" checked="checked">
                                <span class="checkmark"></span>
                            </label>
                            <label class="contain">Maintenance & Spare Parts (6)
                                <input type="radio" name="categories-box" value="maintenance-spare-parts">
                                <span class="checkmark"></span>
                            </label>
                    ...
                    <div class="inner-column"></div>
                        <div class="row">
                            ...
                            <div class="car-block-fourteen col-lg-4 col-md-6 col-sm-6">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="a1.php"><img src="images/resource/USB Car Charger.jpg" alt=""></a></figure>
                                    </div>
                                    <div class="content-box">
                                        ...
                                        <div class="text"><a href="a1.php" title="">USB Car Charger</a></div>
                                        
                                        <a href="#" class="shoping-btn" id="item1">
                            ...
                            <div class="car-block-fourteen col-lg-4 col-md-6 col-sm-6">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="a2.php"><img src="images/resource/Dashboard Camera.jpg" alt=""></a></figure>
                                    </div>
                                    <div class="content-box">
                                        <div class="star-rating">
                                            <span>&#9733;</span>
                                        ...
                                        <div class="text"><a href="a2.php" title="">Dashboard Camera</a></div>
                                       
                                         <a href="#" class="shoping-btn" id="item2">
                                            <i class="fa-solid fa-cart-shopping"></i> Add To Package
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="car-block-fourteen col-lg-4 col-md-6 col-sm-6">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="a3.php"><img src="images/resource/Tire Pressure Monitor.jpg" alt=""></a></figure>
                                    </div>
                                    <div class="content-box">
                                        <div class="star-rating">
                                            <span>&#9733;</span>
                                        ...
                                        <div class="text"><a href="a3.php" title="">Tire Pressure Monitor</a></div>
                                        
                                         <a href="#" class="shoping-btn" id="item3">
                                            <i class="fa-solid fa-cart-shopping"></i> Add To Package
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="car-block-fourteen col-lg-4 col-md-6 col-sm-6">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="a4.php"><img src="images/resource/Fragrance Dispenser.jpg" alt=""></a></figure>
                                    </div>
                                    <div class="content-box">
                                        <div class="star-rating">
                                            <span>&#9733;</span>
                                        ...
                                        <div class="text"><a href="a4.php" title="">Fragrance Dispenser</a></div>
                                        
                                         <a href="#" class="shoping-btn" id="item4">
                                            <i class="fa-solid fa-cart-shopping"></i> Add To Package
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="car-block-fourteen col-lg-4 col-md-6 col-sm-6">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="a5.php"><img src="images/resource/Car Phone Holder.jpg" alt=""></a></figure>
                                    </div>
                                    <div class="content-box">
                                        <div class="star-rating">
                                            <span>&#9733;</span>
                                        ...
                                        <div class="text"><a href="a5.php" title="">Car Phone Holder</a></div>
                                        
                                         <a href="#" class="shoping-btn" id="item5">
                                            <i class="fa-solid fa-cart-shopping"></i> Add To Package
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="car-block-fourteen col-lg-4 col-md-6 col-sm-6">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="a6.php"><img src="images/resource/Travel Neck Pillow.jpg" alt=""></a></figure>
                                    </div>
                                    <div class="content-box">
                                        <div class="star-rating">
                                            <span>&#9733;</span>
                                        ...
                                        <div class="text"><a href="a6.php" title="">Travel Neck Pillow & Blanket Set</a></div>
                                        
                                        <a href="#" class="shoping-btn" id="item6">
                                            <i class="fa-solid fa-cart-shopping"></i> Add To Package
                                        </a>
                                    </div>
                                </div>

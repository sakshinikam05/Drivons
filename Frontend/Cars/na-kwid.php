...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='na-kwid.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='na-kwid.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='na-kwid.php';</script>";
    }
}
...
<head>
<meta charset="utf-8">
<title>Drivons | Nashik-Cars</title>
<!-- Stylesheets -->
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/kwid1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/kwid2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/kwid3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Renault Kwid is a compact, stylish hatchback designed to offer an impressive balance of performance, fuel efficiency, and convenience. Known for its modern looks and features, it’s an ideal choice for city driving. With a powerful engine and a spacious cabin, it provides a comfortable and dynamic driving experience.</div>
    <div class="text">The Kwid features a sporty exterior, a well-designed interior, and a range of smart technologies. It comes equipped with essential safety features to ensure a secure ride. Whether navigating crowded city streets or embarking on long drives, the Kwid offers an enjoyable driving experience with a host of features at an affordable price.</div>
    <ul class="des-list">
    ...
    <div class="row">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Premium Upholstery</li>
                    <li><i class="fa-solid fa-check"></i>Digital Instrument Cluster</li>
                    <li><i class="fa-solid fa-check"></i>Manual Air Conditioning</li>
                    <li><i class="fa-solid fa-check"></i>Smart Media Connectivity</li>
                    <li><i class="fa-solid fa-check"></i>Spacious Cabin</li>
                </ul>
            </div>
        </div>
        <!-- Exterior Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>LED DRLs</li>
                    <li><i class="fa-solid fa-check"></i>Steel Wheels with Covers</li>
                    <li><i class="fa-solid fa-check"></i>Body-Coloured Bumpers</li>
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Driver & Co-Driver Airbags</li>
                    <li><i class="fa-solid fa-check"></i>ABS with EBD</li>
                    <li><i class="fa-solid fa-check"></i>Reverse Parking Sensors</li>
                    <li><i class="fa-solid fa-check"></i>Speed-Sensitive Door Lock</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <ul class="widget-accordion wow fadeInUp">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>1.0L Petrol</li>
                                                <li><span>Max Power</span>67 bhp @ 5500 rpm</li>
                                                <li><span>Max Torque</span>91 Nm @ 4250 rpm</li>
                                                <li><span>Transmission</span>5-Speed Manual / AMT</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>22.5 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>3679 mm</li>
                                                <li><span>Width</span>1579 mm</li>
                                                <li><span>Height</span>1474 mm</li>
                                                <li><span>Wheelbase</span>2360 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Fuel Tank Capacity</span>28 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li class="accordion block v2">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>710 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>279 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>4.7 m</li>
                        ...
                        <div class="location-box">
                            ...
                            <div class="text">Mumbai-Agra Highway, Phalake Smarak, Nashik, B78 2BS
                                Open today 09am - 07pm
                            </div>
                            ...
                            <div class="goole-iframe">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14994.1977996248!2d73.70141770221545!3d20.0274158021258!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bddec301d499201%3A0x3875ca4cb8796c0a!2sGangapur%2C%20Nashik%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1739525247084!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                        <div class="contact-box-three">
                            <div class="icon-box">
                                <img src="images/resource/deal6.jpg">
                            </div>
                            <div class="content-box">
                                <div class="inner-box">
                                    <h6 class="title">Nashik Dealers </h6>
                                ...
                                <div class="btn-box">
                                    <a href="d5.php" class="side-btn">Message Dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                                    ...
                                    <a href="nashik.php" class="side-btn-three">View all stock at this dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Renault Kwid</h2>
                                <div class="text">Petrol 5 Seater</div>
                                <ul class="list">
                                    <li>22.5 km/l Mileage</li>
                                    <li>Petrol</li>
                                    <li>AMT / Manual</li>
                                </ul>
                            </div>
                            <span>Our Price</span>
                            <h3 class="title">₹2,400/day</h3>
                            <small>Instant Saving : ₹2,000/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=39" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                <li><span><img src="images/resource/insep1-1.svg">Body</span>Hatchback</li>
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>22.5 km/l</li>
                                ...
                                <li><span><img src="images/resource/insep1-5.svg">Transmission</span>AMT / Manual</li>
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span>1.0L Petrol</li>
                                <li><span><img src="images/resource/insep1-9.svg">Doors</span>5-door</li>
                                <li><span><img src="images/resource/insep1-10.svg">Cylinders</span>3</li>
                                <li><span><img src="images/resource/insep1-11.svg">Color</span>Red</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>KWID2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

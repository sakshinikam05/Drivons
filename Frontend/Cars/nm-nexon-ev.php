...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='nm-nexon-ev.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='nm-nexon-ev.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='nm-nexon-ev.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nexon1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nexon2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nexon3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Tata Nexon EV is a revolutionary electric SUV designed for urban driving. With its futuristic design and eco-friendly technology, it is the perfect blend of style and sustainability. Offering a quiet, smooth, and dynamic driving experience, it is ideal for eco-conscious individuals who value performance without compromising on the environment.</div>
    <div class="text">The Nexon EV features a modern exterior, a spacious and comfortable cabin, and an array of high-tech features. It provides impressive safety standards and advanced convenience technologies, making it an ideal choice for both city commutes and long-distance journeys. With fast charging and excellent range, the Nexon EV ensures a reliable and enjoyable ride.</div>
    <ul class="des-list">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>Electric Motor</li>
                                                <li><span>Max Power</span>129 PS</li>
                                                <li><span>Max Torque</span>245 Nm</li>
                                                <li><span>Transmission</span>Single-Speed Transmission</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Fuel Type</span>Electric</li>
                                                <li><span>Mileage</span>312 km (ARAI Certified)</li>
                                                <li><span>Emission Norm</span>Zero Emissions</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>3993 mm</li>
                                                <li><span>Width</span>1818 mm</li>
                                                <li><span>Height</span>1606 mm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Ground Clearance</span>205 mm</li>
                                                <li><span>Seating Capacity</span>5 Seater</li>
                                                <li><span>Battery Capacity</span>30.2 kWh</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1400 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>350 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>5.1 m</li>
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Tata Nexon EV</h2>
                                <div class="text">Electric 5 Seater</div>
                                <ul class="list">
                                    <li>5,000 kms</li>
                                    <li>Electric</li>
                                    <li>Automatic</li>
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=21" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>5,000 kms</li>
                                <li><span><img src="images/resource/insep1-3.svg">Fuel Type</span>Electric</li>
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span>Electric Motor</li>
                                <li><span><img src="images/resource/insep1-9.svg">Doors</span>5-door</li>
                                <li><span><img src="images/resource/insep1-10.svg">Cylinders</span>Electric</li>
                                <li><span><img src="images/resource/insep1-11.svg">Color</span>Blue</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>NXEV2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

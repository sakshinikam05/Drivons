...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='nm-brz.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='nm-brz.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='nm-brz.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/brz1.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/brz2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/brz3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Subaru BRZ is a sleek, lightweight sports coupe designed for driving enthusiasts. Known for its precision handling and rear-wheel-drive layout, it offers a pure and engaging driving experience. With a focus on performance and agility, it provides a dynamic connection between car and driver.</div>
    <div class="text">The BRZ boasts a low center of gravity, a responsive 2.4L Boxer engine, and a well-balanced chassis. Whether on twisty mountain roads or at the track, the BRZ excels in delivering a thrilling and controlled ride. It combines sportiness with everyday usability, making it the perfect choice for those seeking an exciting, yet practical, sports car.</div>
    <ul class="des-list">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Max Power</span>228 bhp @ 7000 rpm</li>
                                                <li><span>Max Torque</span>249 Nm @ 3700 rpm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>10-12 km/l</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Height</span>1315 mm</li>
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹5,200/day</h3>
                            <small>Instant Saving : ₹3,700/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=20" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> BRZSUB2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

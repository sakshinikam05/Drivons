...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='na-creta-ev.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='na-creta-ev.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='na-creta-ev.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/creta1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/creta2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/creta3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Hyundai Creta Electric is an eco-friendly, feature-packed electric SUV designed for the modern driver. Known for its futuristic design, zero-emission technology, and advanced features, it is the perfect choice for environmentally conscious drivers looking for power and style. With impressive electric performance and cutting-edge technology, it offers a smooth, dynamic driving experience with zero tailpipe emissions.</div>
    <div class="text">The Creta Electric combines a sleek and modern exterior design with a high-tech and spacious interior. With advanced features such as an electric drivetrain, quick charging, and high-tech safety features, the Creta Electric offers a premium driving experience while contributing to a greener future.</div>
    <ul class="des-list">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Max Power</span>136 bhp</li>
                                                <li><span>Max Torque</span>395 Nm</li>
                                                <li><span>Transmission</span>Single-Speed Automatic</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Range</span>450 km (WLTP)</li>
                                                <li><span>Charging Time</span>60 minutes (Fast Charge)</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1650 kg</li>
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=41" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>450 km</li>
                                ...
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>CRETAEV2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

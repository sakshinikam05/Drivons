...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='m-civic.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='m-civic.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='m-civic.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/civic3.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/civic2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/civic1.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Honda Civic is a dynamic and stylish sedan, offering a perfect blend of performance, comfort, and technology. Known for its reliable engine and sleek design, it’s a favorite among car enthusiasts and those seeking a practical yet fun-to-drive vehicle. The Civic delivers an engaging driving experience, with a smooth ride and sharp handling, making it ideal for city driving and long trips alike.</div>
    <div class="text">With its modern exterior, refined interior, and cutting-edge tech features, the Honda Civic ensures a comfortable and enjoyable ride. The car is equipped with advanced safety features and premium touches that enhance both convenience and luxury. Whether you're navigating city streets or cruising on the highway, the Civic offers a smooth, efficient, and enjoyable experience.</div>
    <ul class="des-list">
    ...
    <div class="row">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Heated Front Seats</li>
                </ul>
            </div>
        </div>
        <!-- Exterior Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>17-inch Alloy Wheels</li>
                    <li><i class="fa-solid fa-check"></i>Shark Fin Antenna</li>
                    <li><i class="fa-solid fa-check"></i>Power Folding Side Mirrors</li>
                </ul>
            </div>
        </div>
        <!-- Safety Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Honda Sensing Suite</li>
                    <li><i class="fa-solid fa-check"></i>Lane Departure Warning</li>
                    <li><i class="fa-solid fa-check"></i>Forward Collision Warning</li>
                    <li><i class="fa-solid fa-check"></i>Adaptive Cruise Control</li>
                    <li><i class="fa-solid fa-check"></i>5-Star NHTSA Rating</li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>2.0L Petrol</li>
                                                <li><span>Max Power</span>158 bhp @ 6500 rpm</li>
                                                <li><span>Max Torque</span>187 Nm @ 4200 rpm</li>
                                                <li><span>Transmission</span>6-Speed Manual / CVT</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>16-18 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4673 mm</li>
                                                <li><span>Width</span>1800 mm</li>
                                                <li><span>Height</span>1416 mm</li>
                                                <li><span>Wheelbase</span>2700 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Fuel Tank Capacity</span>47 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1310 kg</li>
                                                <li><span>No. of Doors</span>4</li>
                                                <li><span>Boot Space</span>428 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>5.6 m</li>
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Honda Civic</h2>
                                <div class="text">1.8L BS6 5 Seater</div>
                                <ul class="list">
                                    <li>25,000 kms</li>
                                    <li>Petrol</li>
                                    <li>Automatic</li>
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹3,600/day</h3>
                            <small>Instant Saving : ₹2,800/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=32" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span> 25,000 kms</li>
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span> 1.8L</li>
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span> Rally Red</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> HDCIVIC2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

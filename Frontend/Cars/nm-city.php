...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='nm-city.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='nm-city.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='nm-city.php';</script>";
    }
}
                        ...
                        <div class="contact-box-three">
                            ...
                            <div class="content-box">
                                ...
                                <div class="btn-box">
                                    ...
                                    <a href="#naviMumbai.php" class="side-btn-three">View all stock at this dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=19" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>

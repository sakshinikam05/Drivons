...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='na-magnite.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='na-magnite.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='na-magnite.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nissan1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nissan2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nissan3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Nissan Magnite is a rugged and powerful SUV designed for both urban and off-road adventures. Known for its bold stance and advanced features, it is perfect for those who seek adventure and comfort. Equipped with a strong engine and modern technology, it ensures a thrilling driving experience.</div>
    <div class="text">The Scorpio-N features a robust exterior, spacious interiors, and a wide range of high-tech features. With a focus on safety and driving dynamics, it offers superior handling, making it an ideal choice for all terrains. Whether on city roads or in the wild, the Scorpio-N delivers an exceptional experience.</div>
    <ul class="des-list">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>2.0L Petrol/Diesel</li>
                                                <li><span>Max Power</span>150 bhp @ 3750 rpm</li>
                                                <li><span>Max Torque</span>320 Nm @ 1500-3000 rpm</li>
                                                <li><span>Transmission</span>6-Speed Manual / Automatic</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>15-20 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4662 mm</li>
                                                <li><span>Width</span>1917 mm</li>
                                                <li><span>Height</span>1857 mm</li>
                                                <li><span>Wheelbase</span>2750 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Fuel Tank Capacity</span>57 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1850 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>460 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                ...
                                <div class="text">2.0L BS6 7 Seater</div>
                                <ul class="list">
                                    <li>10,000 kms</li>
                                    <li>Diesel</li>
                                    <li>Automatic</li>
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹3,400/day</h3>
                            <small>Instant Saving : ₹2,700/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=37" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-4.svg">Year</span> 2024</li>
                                <li><span><img src="images/resource/insep1-5.svg">Transmission</span> Automatic</li>
                                <li><span><img src="images/resource/insep1-6.svg">Drive Type</span> 4WD</li>
                                ...
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> MH12SCORPION2024</li>
                            </ul>
                        </div>
                    </div>
                </div>

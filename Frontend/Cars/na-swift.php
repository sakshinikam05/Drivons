...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='na-swift.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='na-swift.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='na-swift.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/swift1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/swift2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/swift3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Maruti Suzuki Swift is a compact, stylish hatchback offering a perfect balance of performance and comfort. Known for its dynamic design, the Swift is popular for city commutes and long-distance drives alike. It features a punchy engine with excellent fuel efficiency, making it an ideal choice for daily driving and adventure.</div>
    <div class="text">With a sleek and sporty exterior, modern interiors, and an array of advanced features, the Swift provides an engaging driving experience. Equipped with the latest safety and entertainment technologies, it promises comfort and convenience for both the driver and passengers.</div>
    <ul class="des-list">
    ...
    <div class="row">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Fabric Upholstery</li>
                    <li><i class="fa-solid fa-check"></i>SmartPlay Studio Infotainment System</li>
                    <li><i class="fa-solid fa-check"></i>Automatic Climate Control</li>
                    <li><i class="fa-solid fa-check"></i>Keyless Entry</li>
                    <li><i class="fa-solid fa-check"></i>Rear Parking Sensors</li>
                </ul>
            </div>
        </div>
        <!-- Exterior Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>LED Projector Headlamps</li>
                    <li><i class="fa-solid fa-check"></i>Alloy Wheels</li>
                    <li><i class="fa-solid fa-check"></i>Roof Rails</li>
                    <li><i class="fa-solid fa-check"></i>Chrome Door Handles</li>
                </ul>
            </div>
        </div>
        <!-- Safety Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Dual Airbags</li>
                    <li><i class="fa-solid fa-check"></i>ABS with EBD</li>
                    <li><i class="fa-solid fa-check"></i>Rear Parking Camera</li>
                    <li><i class="fa-solid fa-check"></i>Child Safety Lock</li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>1.2L Petrol</li>
                                                <li><span>Max Power</span>89 bhp @ 6000 rpm</li>
                                                <li><span>Max Torque</span>113 Nm @ 4200 rpm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>21-23 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>3840 mm</li>
                                                <li><span>Width</span>1735 mm</li>
                                                <li><span>Height</span>1530 mm</li>
                                                <li><span>Wheelbase</span>2450 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>890 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>268 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>4.8 m</li>
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                ...
                                <ul class="list">
                                    <li>23.2 km/l Mileage</li>
                                    <li>Petrol</li>
                                    <li>AMT / Manual</li>
                                </ul>
                            </div>
                            <span>Our Price</span>
                            <h3 class="title">₹2,500/day</h3>
                            <small>Instant Saving : ₹2,100/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=38" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>23.2 km/l</li>
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span>1.2L Petrol</li>
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span>Prime Red</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>SWIFT2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

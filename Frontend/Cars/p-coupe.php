...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='p-coupe.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='p-coupe.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='p-coupe.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/si1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/si2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/si3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Honda Civic Si Coupe is a sportier version of the popular Honda Civic. With its sleek design and enhanced performance features, it offers a thrilling driving experience. Powered by a 1.5L turbocharged engine, the Civic Si Coupe delivers a balance of power and efficiency, making it an ideal choice for those seeking both fun and practicality.</div>
    <div class="text">The Civic Si Coupe features a bold exterior design, sport-inspired interior, and cutting-edge technology. Whether you're cruising through the city or taking on winding roads, this car provides a dynamic and engaging ride. It also boasts advanced safety features, ensuring a secure and enjoyable driving experience.</div>
    <ul class="des-list">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Gloss Black Front Grille</li>
                </ul>
            </div>
        </div>
        <!-- Safety Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Rearview Camera</li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>1.5L Turbocharged Petrol</li>
                                                <li><span>Max Power</span>205 bhp @ 5700 rpm</li>
                                                <li><span>Max Torque</span>260 Nm @ 2300-4300 rpm</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4520 mm</li>
                                                <li><span>Width</span>1795 mm</li>
                                                <li><span>Height</span>1370 mm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Fuel Tank Capacity</span>46 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Boot Space</span>343 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Honda Civic Si Coupe</h2>
                                <div class="text">1.5L Turbocharged BS6 5 Seater</div>
                                <ul class="list">
                                    <li>25,000 kms</li>
                                    <li>Petrol</li>
                                    <li>Manual</li>
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹4,400/day</h3>
                            <small>Instant Saving : ₹3,200/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=14" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span> 1.5L Turbocharged</li>
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span> Rallye Red</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> HND12345CIVIC2022</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='m-tiago.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='m-tiago.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='m-tiago.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/tiago1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/tiago2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/tiago3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Tata Tiago is a compact, stylish, and feature-rich hatchback designed to meet the needs of urban drivers. With a bold design and modern features, it offers great value for money. Known for its fuel efficiency, the Tiago offers a comfortable and enjoyable driving experience, ideal for both city commutes and weekend getaways.</div>
    <div class="text">The Tiago boasts a contemporary exterior, a refined interior, and a range of smart technologies that enhance convenience. Equipped with advanced safety features, it ensures a secure ride for its passengers. Whether you're driving in the city or heading out for a road trip, the Tiago delivers excellent performance and comfort.</div>
    <ul class="des-list">
    ...
    <div class="row">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>7-inch Touchscreen System</li>
                    <li><i class="fa-solid fa-check"></i>Height Adjustable Driver Seat</li>
                </ul>
            </div>
        </div>
        <!-- Exterior Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Halogen Projector Headlamps</li>
                    <li><i class="fa-solid fa-check"></i>Dual-Tone Roof</li>
                    <li><i class="fa-solid fa-check"></i>Body-Color ORVMs, Indicators</li>
                    <li><i class="fa-solid fa-check"></i>Chrome Accents</li>
                </ul>
            </div>
        </div>
        <!-- Safety Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Corner Stability Control</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <ul class="widget-accordion wow fadeInUp">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Max Power</span>85 bhp @ 6000 rpm</li>
                                                <li><span>Max Torque</span>114 Nm @ 3500 rpm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>19.8 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>3746 mm</li>
                                                <li><span>Width</span>1647 mm</li>
                                                <li><span>Height</span>1537 mm</li>
                                                <li><span>Wheelbase</span>2400 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Fuel Tank Capacity</span>35 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li class="accordion block v2">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>950 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>242 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>4.9 m</li>
                        ...
                        <div class="location-box">
                            ...
                            <div class="text">Andheri Kurla Road, Sakinaka, Mumbai, B30 4BS
                                Open today 11am - 8pm
                            </div>
                            ...
                            <div class="goole-iframe">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30158.70780388745!2d72.84789087245599!3d19.114740704235576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b61b41dfb131%3A0xa668297563ddac31!2sAndheri%20East%2C%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1739525173568!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                        <div class="contact-box-three">
                            <div class="icon-box">
                                <img src="images/resource/deal5.jpg">
                            </div>
                            <div class="content-box">
                                <div class="inner-box">
                                    <h6 class="title">Mumbai Dealers </h6>
                                ...
                                <div class="btn-box">
                                    <a href="d4.php" class="side-btn">Message Dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                                    ...
                                    <a href="mumbai.php" class="side-btn-three">View all stock at this dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=30" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>19.8 km/l</li>
                                ...
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>TIAGO2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='s-aura.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='s-aura.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='s-aura.php';</script>";
    }
}
        ...
        <div class="drivons-container">
            <div class="drivons-title-three">
                <ul class="breadcrumb">
                    ...
                    <li><span> Sambhaji Nagar Cars</span></li>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/aura1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/aura2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/aura3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Hyundai Aura is a sleek and stylish sedan, perfect for those who appreciate luxury and performance. With its refined design, powerful engine, and advanced safety features, the Aura offers a superior driving experience. Whether commuting in the city or embarking on a long road trip, the Aura delivers comfort and sophistication.</div>
    <div class="text">The Aura boasts an elegant exterior, spacious interior, and top-of-the-line technology. It comes equipped with advanced driver assistance systems to ensure safety, while its smooth handling and fuel-efficient engine make every drive enjoyable. Experience premium comfort and performance with the Aura.</div>
    <ul class="des-list">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>2.5L Petrol</li>
                                                <li><span>Max Power</span>205 bhp @ 6600 rpm</li>
                                                <li><span>Max Torque</span>250 Nm @ 4200 rpm</li>
                                                <li><span>Transmission</span>8-Speed Automatic</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>14-16 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4885 mm</li>
                                                <li><span>Width</span>1840 mm</li>
                                                <li><span>Height</span>1445 mm</li>
                                                <li><span>Wheelbase</span>2825 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1500 kg</li>
                                                <li><span>No. of Doors</span>4</li>
                                                <li><span>Boot Space</span>524 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>5.8 m</li>
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Hyundai Aura</h2>
                                <div class="text">2.5L Petrol 5 Seater</div>
                                <ul class="list">
                                    <li>10,000 kms</li>
                                    <li>Petrol</li>
                                    <li>Automatic</li>
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹2,200/day</h3>
                            <small>Instant Saving : ₹1,800/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=24" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span> Silver Metallic</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> AB12CAM2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

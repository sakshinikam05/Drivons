...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='p-dzire.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='p-dzire.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='p-dzire.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/dzire1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/dzire2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/dzire3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Maruti Suzuki Dzire is a compact sedan known for its elegant design, impressive fuel efficiency, and smooth performance. Perfect for urban and highway driving, it offers a blend of style, comfort, and technology, making it an ideal choice for both daily commutes and long drives.</div>
    <div class="text">The Dzire comes with a modern exterior design, well-equipped interiors, and a range of advanced features. It prioritizes passenger comfort and safety, offering a balanced driving experience with efficient performance and excellent road presence.</div>
    <ul class="des-list">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Smartplay Studio Touchscreen</li>
                    <li><i class="fa-solid fa-check"></i>Automatic Climate Control</li>
                    <li><i class="fa-solid fa-check"></i>Smart Keyless Entry</li>
                    <li><i class="fa-solid fa-check"></i>Push Start/Stop Button</li>
                </ul>
            </div>
        </div>
        <!-- Exterior Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Electric ORVMs with Turn Indicators</li>
                </ul>
            </div>
        </div>
        <!-- Safety Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Rear View Camera</li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Transmission</span>5-Speed Manual / 5-Speed AMT</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>23-24 km/l</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Height</span>1515 mm</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>860 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>378 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                ...
                                <div class="text">1.2L Petrol 5 Seater</div>
                                <ul class="list">
                                    <li>15,000 kms</li>
                                    <li>Petrol</li>
                            ...
                            <small>Instant Saving : ₹1,900/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=11" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span> 1.2L</li>
                                ...
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> DZ12SUZ2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

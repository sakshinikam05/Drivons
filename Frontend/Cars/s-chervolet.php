...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='s-chervolet.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='s-chervolet.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='s-chervolet.php';</script>";
    }
}
...
<head>
<meta charset="utf-8">
<title>Drivons | Sambhaji Nagar-Cars</title>
<!-- Stylesheets -->
        ...
        <div class="drivons-container">
            <div class="drivons-title-three">
                <ul class="breadcrumb">
                    ...
                    <li><span>Sambhajinagar Cars</span></li>
                </ul>
            </div>
            <div class="row">
                <div class="inspection-column v2 col-lg-7 col-md-12 col-sm-12">
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/tavera1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/tavera2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/tavera3.jpg" alt=""></a></figure>
                   ...
                   <div class="description-sec">
                         ...
                         <div class="text two">The Chevrolet Tavera is a robust and spacious SUV designed for both urban and rural terrains. Known for its durability and comfortable seating, it is an ideal choice for large families and long journeys. With a powerful diesel engine, it offers excellent fuel efficiency and performance.</div>
                         <div class="text">The Tavera features a sturdy chassis, high ground clearance, and a spacious interior with ample legroom. It is equipped with modern amenities and safety features, making it a popular choice in the SUV segment. Whether you're driving in the city or on rough terrains, the Tavera ensures a smooth and comfortable ride.</div>
                         <ul class="des-list">
    ...
    <div class="row">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Fabric Seats</li>
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Alloy Wheels</li>
                    <li><i class="fa-solid fa-check"></i>Power Windows</li>
                </ul>
            </div>
        </div>
        <!-- Safety Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>ABS (Anti-lock Braking System)</li>
                    <li><i class="fa-solid fa-check"></i>Child Safety Locks</li>
                    <li><i class="fa-solid fa-check"></i>Driver Airbag</li>
                    <li><i class="fa-solid fa-check"></i>Seat Belt Warning</li>
                </ul>
            </div>
        </div>
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Rear AC Vents</li>
                    <li><i class="fa-solid fa-check"></i>Adjustable Seats</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <ul class="widget-accordion wow fadeInUp">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>2.5L Diesel</li>
                                                <li><span>Max Power</span>78 bhp @ 4000 rpm</li>
                                                <li><span>Max Torque</span>195 Nm @ 1800 rpm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>12 km/l (City), 15 km/l (Highway)</li>
                                                <li><span>Emission Norm</span>BS4</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4595 mm</li>
                                                <li><span>Width</span>1770 mm</li>
                                                <li><span>Height</span>1920 mm</li>
                                                <li><span>Wheelbase</span>2800 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Seating Capacity</span>7-9 Seater</li>
                                                <li><span>Fuel Tank Capacity</span>55 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li class="accordion block v2">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1750 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>Not Specified</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>5.5 m</li>
                                                <li><span>Spare Wheel</span>Alloy</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="location-box">
                            ...
                            <div class="text">High court hill, Motiwala Complex, sambhajinagar, B60 1BS
                                Open today 08am - 6pm
                            </div>
                            ...
                            <div class="goole-iframe">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60032.70223393397!2d75.31178710725223!3d19.880368546850562!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdba2dd02059929%3A0x119ff537d5e9095d!2sChilkalthana%2C%20Chhatrapati%20Sambhaji%20Nagar%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1739525110054!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                        <div class="contact-box-three">
                            <div class="icon-box">
                                <img src="images/resource/deal4.jpg">
                            </div>
                            <div class="content-box">
                                <div class="inner-box">
                                    <h6 class="title">Sambhaji Nagar Dealers </h6>
                                ...
                                <div class="btn-box">
                                    <a href="d3.php" class="side-btn">Message Dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                                    ...
                                    <a href="sambhajinagar.php" class="side-btn-three">View all stock at this dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Chevrolet Tavera</h2>
                                <div class="text">2.5L BS4 7-9 Seater</div>
                                <ul class="list">
                                    <li>45,000 kms</li>
                                    <li>Diesel</li>
                                    <li>Manual</li>
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹3,200/day</h3>
                            <small>Instant Saving : ₹2,500/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=25" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                           <!-- overview-sec -->
                                            <div class="overview-box">
                                                ...
                                                <ul class="list">
                                                    ...
                                                    <li><span><img src="images/resource/insep1-2.svg">Mileage</span>35,000 miles</li>
                                                    <li><span><img src="images/resource/insep1-3.svg">Fuel Type</span>Diesel</li>
                                                    <li><span><img src="images/resource/insep1-4.svg">Year</span>2019</li>
                                                    <li><span><img src="images/resource/insep1-5.svg">Transmission</span>Manual</li>
                                                    ...
                                                    <li><span><img src="images/resource/insep1-8.svg">Engine Size</span>2.5L</li>
                                                    ...
                                                    <li><span><img src="images/resource/insep1-11.svg">Color</span>White</li>
                                                    <li><span><img src="images/resource/insep1-12.svg">VIN</span>MH12AB1234TAVERA</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>

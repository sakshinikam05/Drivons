...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='n-ciaz.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='n-ciaz.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='n-ciaz.php';</script>";
    }
}
...
<head>
<meta charset="utf-8">
<title>Drivons | Nagpur-Cars</title>
<!-- Stylesheets -->
                ...
                <ul class="widget-accordion wow fadeInUp">
                    ...
                    <li class="accordion block v2">
                        ...
                        <div class="location-box">
                            ...
                            <div class="text">Khamla Ring Road,MIDC, Nagpur, B95 6BS
                            ...
                            <div class="goole-iframe">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d174777.16753179923!2d78.66190718470504!3d20.86685072721622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd4997e15ea1203%3A0xdec3b639493e5865!2sAdditional%20Butibori%20Industrial%20Area%20(MIDC)%2C%20Nagpur!5e0!3m2!1sen!2sin!4v1739525337315!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

                            </div>
                        </div>
                        <div class="contact-box-three">
                            <div class="icon-box">
                                <img src="images/resource/deal7.jpg">
                            </div>
                            <div class="content-box">
                                <div class="inner-box">
                                    <h6 class="title">Nagpur Dealers </h6>
                                ...
                                <div class="btn-box">
                                    <a href="d6.php" class="side-btn">Message Dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                                    ...
                                    <a href="nagpur.php" class="side-btn-three">View all stock at this dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=43" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>

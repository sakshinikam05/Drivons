...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='s-ciaz.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='s-ciaz.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='s-ciaz.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/ciaz1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/ciaz2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/ciaz3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Maruti Suzuki Ciaz is a stylish and feature-rich sedan that offers a perfect blend of luxury and performance. With its sleek design and advanced features, it is an ideal choice for families looking for comfort and reliability. Powered by efficient engines, the Ciaz ensures a smooth driving experience both in the city and on the highways.</div>
    <div class="text">The Ciaz features a premium exterior with a sophisticated interior that emphasizes comfort and convenience. Loaded with innovative technologies, the car guarantees a secure and enjoyable ride for all passengers. Whether you are on a long road trip or navigating through city traffic, the Maruti Suzuki Ciaz delivers an exceptional driving experience.</div>
    <ul class="des-list">
    ...
    <div class="row">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>SmartPlay Studio</li>
                    <li><i class="fa-solid fa-check"></i>Automatic Climate Control</li>
                    <li><i class="fa-solid fa-check"></i>Push Button Start</li>
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>LED Daytime Running Lamps</li>
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Dual Front Airbags</li>
                    <li><i class="fa-solid fa-check"></i>ABS with EBD</li>
                    <li><i class="fa-solid fa-check"></i>Rear Parking Sensors</li>
                    <li><i class="fa-solid fa-check"></i>Isofix Child Seat Anchors</li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Max Power</span>105 bhp @ 6000 rpm</li>
                                                <li><span>Max Torque</span>138 Nm @ 4400 rpm</li>
                                                <li><span>Transmission</span>5-Speed Manual / 4-Speed Automatic</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>20.65 km/l (Petrol)</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4490 mm</li>
                                                <li><span>Width</span>1730 mm</li>
                                                <li><span>Height</span>1485 mm</li>
                                                <li><span>Wheelbase</span>2650 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Fuel Tank Capacity</span>43 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1035 kg</li>
                                                <li><span>No. of Doors</span>4</li>
                                                <li><span>Boot Space</span>510 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Maruti Suzuki Ciaz</h2>
                                <div class="text">1.5L Petrol 5 Seater</div>
                                <ul class="list">
                                    <li>20,000 kms</li>
                                    <li>Petrol</li>
                                    <li>Manual</li>
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹2,900/day</h3>
                            <small>Instant Saving : ₹2,400/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=23" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                <li><span><img src="images/resource/insep1-1.svg">Body</span> Sedan</li>
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span> 20,000 kms</li>
                                ...
                                <li><span><img src="images/resource/insep1-9.svg">Doors</span> 4-door</li>
                                <li><span><img src="images/resource/insep1-10.svg">Cylinders</span> 4</li>
                                <li><span><img src="images/resource/insep1-11.svg">Color</span> Pearl Midnight Black</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> MH12CIZ2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

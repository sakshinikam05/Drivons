...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='nm-ertiga.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='nm-ertiga.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='nm-ertiga.php';</script>";
    }
}
...
<head>
<meta charset="utf-8">
<title>Drivons | Navi-Mumbai-Cars</title>
<!-- Stylesheets -->
        ...
        <div class="drivons-container">
            <div class="drivons-title-three">
                <ul class="breadcrumb">
                    ...
                    <li><span>Navi-Mumbai Cars</span></li>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/ertiga.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/ertiga2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/ertiga3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Maruti Suzuki Ertiga is a versatile and spacious MPV, designed to cater to the needs of large families and urban commuters alike. It offers a perfect blend of comfort, style, and practicality, with modern features and a reliable engine. The Ertiga ensures a smooth ride, whether in city traffic or on long road trips.</div>
    <div class="text">With a contemporary design, spacious interiors, and cutting-edge technology, the Ertiga provides a comfortable and convenient driving experience. Equipped with a fuel-efficient engine and advanced safety features, it is an ideal choice for those seeking an all-rounder for their family transportation needs.</div>
    <ul class="des-list">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Multi-Information Display</li>
                    <li><i class="fa-solid fa-check"></i>Automatic Climate Control</li>
                    <li><i class="fa-solid fa-check"></i>Smart Play Studio</li>
                    <li><i class="fa-solid fa-check"></i>Third Row of Seats</li>
                </ul>
            </div>
        </div>
        <!-- Exterior Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Body-Coloured ORVMs with Turn Indicators</li>
                    <li><i class="fa-solid fa-check"></i>Rear Defogger</li>
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Hill Hold Control</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <ul class="widget-accordion wow fadeInUp">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Max Power</span>103 bhp @ 6000 rpm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>19-26 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4395 mm</li>
                                                <li><span>Width</span>1735 mm</li>
                                                <li><span>Height</span>1690 mm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Ground Clearance</span>185 mm</li>
                                                <li><span>Seating Capacity</span>7 Seater</li>
                                                <li><span>Fuel Tank Capacity</span>45 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li class="accordion block v2">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1200 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>153 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="location-box">
                            ...
                            <div class="text">Palm Beach Road, satara Plaza, Navi Mumbai, B46 5BS
                                Open today 10am - 6pm
                            </div>
                            ...
                            <div class="goole-iframe">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30165.66954778295!2d72.97796037239496!3d19.076541356175998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c136b519107b%3A0x8452b99754be0fc8!2sVashi%2C%20Navi%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1739525047707!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                                </iframe>                                
                            </div>
                        </div>
                        <div class="contact-box-three">
                            <div class="icon-box">
                                <img src="images/resource/deal3.jpg">
                            </div>
                            <div class="content-box">
                                <div class="inner-box">
                                    <h6 class="title">Navi Mumbai Dealers </h6>
                                ...
                                <div class="btn-box">
                                    <a href="d2.php" class="side-btn">Message Dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                                    ...
                                    <a href="nviMumbai.php" class="side-btn-three">View all stock at this dealer<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewbox="0 0 14 14" fill="none">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                ...
                                <div class="text">1.5L BS6 7 Seater</div>
                                <ul class="list">
                                    <li>20,000 kms</li>
                                    <li>Petrol</li>
                                    <li>Manual</li>
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=18" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                <li><span><img src="images/resource/insep1-1.svg">Body</span> MPV</li>
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span> Pearl Arctic White</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> MH12ERTIGA2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='p-maita.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='p-maita.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='p-maita.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/mx1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/mx2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/mx3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Mazda MX-5 Miata RF is a sporty and dynamic convertible sports car, offering an exciting driving experience. With its sleek design and rear-wheel drive setup, it delivers precision handling and exceptional performance. Perfect for driving enthusiasts who value agility and style, the Miata RF makes every drive an adventure.</div>
    <div class="text">The MX-5 Miata RF features a distinctive fastback design with a retractable hardtop, providing the freedom of both open-air and closed-roof driving. The compact size and lightweight build contribute to its nimble handling, while the interior offers a refined and driver-focused environment with advanced technology and comfort features.</div>
    <ul class="des-list">
    ...
    <div class="row">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>7-inch Touchscreen Infotainment</li>
                    <li><i class="fa-solid fa-check"></i>BOSE Premium Audio System</li>
                    <li><i class="fa-solid fa-check"></i>Heated Seats</li>
                    <li><i class="fa-solid fa-check"></i>Smart Keyless Entry</li>
                </ul>
            </div>
        </div>
        <!-- Exterior Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>18-inch Alloy Wheels</li>
                    <li><i class="fa-solid fa-check"></i>Retractable Hardtop Roof</li>
                    <li><i class="fa-solid fa-check"></i>Dual Exhaust System</li>
                </ul>
            </div>
        </div>
        <!-- Safety Features -->
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    <li><i class="fa-solid fa-check"></i>Advanced Blind Spot Monitoring</li>
                    <li><i class="fa-solid fa-check"></i>Rear Cross Traffic Alert</li>
                    <li><i class="fa-solid fa-check"></i>Emergency Braking</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Max Power</span>181 bhp @ 7000 rpm</li>
                                                <li><span>Max Torque</span>205 Nm @ 4600 rpm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>12-15 km/l</li>
                                                <li><span>Emission Norm</span>Euro 6</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>3915 mm</li>
                                                <li><span>Width</span>1735 mm</li>
                                                <li><span>Height</span>1235 mm</li>
                                                <li><span>Wheelbase</span>2310 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Seating Capacity</span>2 Seater</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1050 kg</li>
                                                <li><span>No. of Doors</span>2</li>
                                                <li><span>Boot Space</span>130 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                <h2>Mazda MX-5 Miata RF</h2>
                                <div class="text">2.0L Petrol 2 Seater</div>
                                <ul class="list">
                                    <li>15,000 kms</li>
                                    <li>Petrol</li>
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹5,800/day</h3>
                            <small>Instant Saving : ₹4,000/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=15" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                <li><span><img src="images/resource/insep1-1.svg">Body</span> Convertible</li>
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span> 2.0L</li>
                                ...
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> MX5RF2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

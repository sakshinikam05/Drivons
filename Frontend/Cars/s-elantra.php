...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='s-elantra.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='s-elantra.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='s-elantra.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/elantra1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/elatra2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/elantra3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Hyundai Elantra is a sleek and stylish sedan designed for modern-day urban and highway driving. Known for its bold design, cutting-edge technology, and remarkable fuel efficiency, it is a top choice for those seeking comfort, performance, and practicality. The Elantra delivers an engaging driving experience with its powerful yet efficient engine options.</div>
    <div class="text">The Elantra offers a premium interior with high-quality materials and advanced features. Equipped with the latest technology and safety systems, it provides a secure and convenient driving experience. Whether commuting in the city or cruising on the highway, the Elantra combines comfort with performance.</div>
    <ul class="des-list">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4640 mm</li>
                                                <li><span>Width</span>1800 mm</li>
                                                <li><span>Height</span>1450 mm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Boot Space</span>402 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=26" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>17-21 km/l</li>
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span>1.5L Petrol</li>
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span>Phantom Black</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>ELANTRA2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='p-nios.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='p-nios.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='p-nios.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nios1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nios2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/nios3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Hyundai Grand i10 Nios is a compact and stylish hatchback that combines performance, comfort, and advanced technology. Known for its sporty design and modern features, it is ideal for urban driving. With a fuel-efficient engine and user-friendly features, it offers a dynamic and enjoyable driving experience.</div>
    <div class="text">The Grand i10 Nios is equipped with a sophisticated exterior design, spacious interiors, and a range of high-tech features. It offers a smooth ride, enhanced safety, and top-class connectivity features. Whether navigating busy city streets or cruising on highways, the Grand i10 Nios ensures a delightful journey.</div>
    <ul class="des-list">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Max Power</span>83 bhp @ 6000 rpm</li>
                                                <li><span>Max Torque</span>114 Nm @ 4000 rpm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>18-20 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>3795 mm</li>
                                                <li><span>Width</span>1680 mm</li>
                                                <li><span>Height</span>1520 mm</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>980 kg</li>
                                                <li><span>No. of Doors</span>5</li>
                                                <li><span>Boot Space</span>260 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <div class="btn-box">
                                ...
                                <a href="wd.php?car_id=17" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>20.0 km/l</li>
                                ...
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>GRANDI10N2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

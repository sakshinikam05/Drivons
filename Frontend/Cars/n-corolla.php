...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='n-corolla.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='n-corolla.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='n-corolla.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/corolla3.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/corolla2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/corolla1.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Toyota Corolla is a compact sedan that has earned a reputation for reliability and excellent fuel efficiency. Known for its sleek design and advanced technology, it remains one of the most popular cars in the world. With a comfortable ride and a range of modern features, it is ideal for daily commutes and long drives alike.</div>
    <div class="text">The Corolla comes with a stylish exterior, high-quality interior materials, and an array of smart technologies. It includes a range of safety features, making it an attractive option for families and first-time car buyers. Whether in the city or on the highway, the Toyota Corolla delivers a smooth, responsive driving experience.</div>
    <ul class="des-list">
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>1.8L Petrol / 1.8L Hybrid</li>
                                                <li><span>Max Power</span>138 bhp @ 6400 rpm</li>
                                                <li><span>Max Torque</span>172 Nm @ 4000 rpm</li>
                                                <li><span>Transmission</span>CVT / Manual</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Fuel Type</span>Petrol / Hybrid</li>
                                                <li><span>Mileage</span>14-22 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4630 mm</li>
                                                <li><span>Width</span>1775 mm</li>
                                                <li><span>Height</span>1455 mm</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Boot Space</span>470 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="inner-column">
                        <div class="contact-box-two">
                            <div class="content-box">
                                ...
                                <ul class="list">
                                    <li>14-22 km/l Mileage</li>
                                    <li>Petrol</li>
                                    <li>CVT / Manual</li>
                                </ul>
                            </div>
                            <span>Our Price</span>
                            <h3 class="title">₹3,800/day</h3>
                            <small>Instant Saving : ₹3,100/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=50" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                <li><span><img src="images/resource/insep1-1.svg">Body</span>Hybrid</li>
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span>14-22 km/l</li>
                                ...
                                <li><span><img src="images/resource/insep1-5.svg">Transmission</span>CVT / Manual</li>
                                ...
                                <li><span><img src="images/resource/insep1-8.svg">Engine Size</span>1.8L Petrol</li>
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span>Silver</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span>COROLLA2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

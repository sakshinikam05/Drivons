...
if (isset($_POST['send'])) {
    ...
    try {
        if ($query->execute()) {
            echo "<script>alert('Reply saved successfully!'); window.location.href='na-city.php';</script>";
        } else {
            echo "<script>alert('Error saving reply.'); window.location.href='na-city.php';</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Database error: " . $e->getMessage() . "'); window.location.href='na-city.php';</script>";
    }
}
                        ...
                        <div class="gallery-sec">
                            <div class="image-column wrap-gallery-box">
                                <div class="inner-column inventry-slider-two">
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/city1.jpg" alt=""></a></figure>
                                        
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/city2.jpg" alt=""></a></figure>
                                       
                                    </div>
                                    <div class="image-box">
                                        <figure class="image"><a data-fancybox="gallery"><img src="images/carsin/city3.jpg" alt=""></a></figure>
...
<div class="description-sec">
    ...
    <div class="text two">The Honda City is a premium sedan known for its elegant design, exceptional fuel efficiency, and advanced technology. Offering a perfect blend of comfort and performance, it is ideal for both city driving and long-distance travel. With its sleek profile and modern features, the City provides an enjoyable and dynamic driving experience.</div>
    <div class="text">The Honda City comes with a refined exterior, plush interiors, and the latest technology for safety and convenience. Equipped with a powerful yet efficient engine, it ensures a smooth ride with a host of features that make every journey more enjoyable and secure.</div>
    <ul class="des-list">
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>7-inch Touchscreen Display</li>
        ...
        <div class="list-column col-lg-4 col-md-6 col-sm-12">
            <div class="inner-column">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fa-solid fa-check"></i>Reverse Parking Camera</li>
                    <li><i class="fa-solid fa-check"></i>Vehicle Stability Assist</li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Engine Type</span>1.5L Petrol</li>
                                                <li><span>Max Power</span>121 bhp @ 6600 rpm</li>
                                                <li><span>Max Torque</span>145 Nm @ 4300 rpm</li>
                                                <li><span>Transmission</span>5-Speed Manual / CVT</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                ...
                                                <li><span>Mileage</span>17.8 km/l</li>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Length</span>4440 mm</li>
                                                <li><span>Width</span>1695 mm</li>
                                                <li><span>Height</span>1475 mm</li>
                                                <li><span>Wheelbase</span>2600 mm</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Ground Clearance</span>165 mm</li>
                                                <li><span>Seating Capacity</span>5 Seater</li>
                                                <li><span>Fuel Tank Capacity</span>40 Litres</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Kerb Weight</span>1060 kg</li>
                                    ...
                                    <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        <div class="inner-column">
                                            <ul class="spects-list">
                                                <li><span>Turning Radius</span>5.3 m</li>
                ...
                <div class="side-bar-column v2 v3 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-box-two">
                            ...
                            <span>Our Price</span>
                            <h3 class="title">₹3,000/day</h3>
                            <small>Instant Saving : ₹2,400/day</small>
                            <div class="btn-box">
                                 
                                <a href="wd.php?car_id=33" class="side-btn two"><img src="images/resource/tag1-1.svg">Book A Car</a>
                            </div>
                        </div>
                        ...
                        <div class="overview-box">
                            ...
                            <ul class="list">
                                ...
                                <li><span><img src="images/resource/insep1-2.svg">Mileage</span> 15,000 kms</li>
                                ...
                                <li><span><img src="images/resource/insep1-11.svg">Color</span> Radiant Red</li>
                                <li><span><img src="images/resource/insep1-12.svg">VIN</span> MH12CITY2023</li>
                            </ul>
                        </div>
                    </div>
                </div>

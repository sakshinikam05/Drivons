    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            try {
                ...
                $mail->Password = 'kagy kqij yhva ujri'; // Replace with your Gmail App Password
...
<head>
    ...
    <style>
        body, html {
            ...
            background-image: url(images/resource/banner-hp3_enhanced_enhanced.jpg);
        }
        .container {
            display: flex;
            width: 80%;
            ...
            box-shadow: 0px 10px 35px 0px rgba(0, 0, 0, 0.847);
            justify-content: center;
            align-items: center;
